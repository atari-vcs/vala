...
static gint ValaCCodeMacroReplacement_private_offset;
...
vala_ccode_macro_replacement_get_instance_private (ValaCCodeMacroReplacement* self)
{
	return G_STRUCT_MEMBER_P (self, ValaCCodeMacroReplacement_private_offset);
}
...
vala_ccode_macro_replacement_class_init (ValaCCodeMacroReplacementClass * klass)
{
	...
	g_type_class_adjust_private_offset (klass, &ValaCCodeMacroReplacement_private_offset);
...
{
	self->priv = vala_ccode_macro_replacement_get_instance_private (self);
}
...
vala_ccode_macro_replacement_get_type (void)
{
	...
	if (g_once_init_enter (&vala_ccode_macro_replacement_type_id__volatile)) {
		...
		ValaCCodeMacroReplacement_private_offset = g_type_add_instance_private (vala_ccode_macro_replacement_type_id, sizeof (ValaCCodeMacroReplacementPrivate));
