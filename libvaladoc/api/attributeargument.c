...
static gint ValadocApiAttributeArgument_private_offset;
...
valadoc_api_attribute_argument_get_instance_private (ValadocApiAttributeArgument* self)
{
	return G_STRUCT_MEMBER_P (self, ValadocApiAttributeArgument_private_offset);
}
                                          ...
                                          ValaAttribute* data)
{
	...
	g_return_val_if_fail (value != NULL, NULL);
	g_return_val_if_fail (data != NULL, NULL);
	self = (ValadocApiAttributeArgument*) valadoc_api_item_construct (object_type, (ValaCodeNode*) data);
...
valadoc_api_attribute_argument_real_build_signature (ValadocApiItem* base)
{
	...
	valadoc_api_signature_builder_append_attribute (builder, _tmp1_, TRUE);
	valadoc_api_signature_builder_append_attribute (builder, "=", TRUE);
	_tmp2_ = self->priv->_value;
	valadoc_api_signature_builder_append_literal (builder, _tmp2_, TRUE);
	_tmp3_ = valadoc_api_signature_builder_get (builder);
...
valadoc_api_attribute_argument_class_init (ValadocApiAttributeArgumentClass * klass)
{
	...
	g_type_class_adjust_private_offset (klass, &ValadocApiAttributeArgument_private_offset);
...
{
	self->priv = valadoc_api_attribute_argument_get_instance_private (self);
}
...
valadoc_api_attribute_argument_get_type (void)
{
	...
	if (g_once_init_enter (&valadoc_api_attribute_argument_type_id__volatile)) {
		...
		ValadocApiAttributeArgument_private_offset = g_type_add_instance_private (valadoc_api_attribute_argument_type_id, sizeof (ValadocApiAttributeArgumentPrivate));
