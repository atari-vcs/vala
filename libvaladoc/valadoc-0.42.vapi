/* valadoc-0.42.vapi generated by valac, do not modify. */
...
namespace Valadoc {
	namespace Api {
		...
		public class Attribute : Valadoc.Api.Item {
			...
			public Valadoc.Api.AttributeArgument add_boolean (string name, bool value, Vala.Attribute data);
			public Valadoc.Api.AttributeArgument add_double (string name, double value, Vala.Attribute data);
			public Valadoc.Api.AttributeArgument add_integer (string name, int value, Vala.Attribute data);
			public Valadoc.Api.AttributeArgument add_string (string name, string value, Vala.Attribute data);
			protected override Valadoc.Content.Inline build_signature ();
		...
		public class AttributeArgument : Valadoc.Api.Item {
			...
			public AttributeArgument.boolean (Valadoc.Api.Attribute parent, Valadoc.Api.SourceFile file, global::string name, bool value, Vala.Attribute data);
			protected override Valadoc.Content.Inline build_signature ();
			public AttributeArgument.double (Valadoc.Api.Attribute parent, Valadoc.Api.SourceFile file, global::string name, global::double value, Vala.Attribute data);
			public Valadoc.Api.SourceFile get_source_file ();
			...
			public AttributeArgument.integer (Valadoc.Api.Attribute parent, Valadoc.Api.SourceFile file, global::string name, int value, Vala.Attribute data);
			public AttributeArgument.string (Valadoc.Api.Attribute parent, Valadoc.Api.SourceFile file, global::string name, global::string value, Vala.Attribute data);
		...
		public class Constant : Valadoc.Api.Member {
			public Constant (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, string? cname, Vala.Constant data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string get_cname ();
		...
		public class Delegate : Valadoc.Api.TypeSymbol, Valadoc.Api.Callable {
			public Delegate (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, string? cname, bool is_static, Vala.Delegate data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
		...
		public class Enum : Valadoc.Api.TypeSymbol {
			public Enum (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, string? cname, string? type_macro_name, string? type_function_name, Vala.Enum data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
			public string? get_type_id ();
		...
		public class EnumValue : Valadoc.Api.Symbol {
			public EnumValue (Valadoc.Api.Enum parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SourceComment? comment, string? cname, Vala.EnumValue data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string get_cname ();
		...
		public class ErrorCode : Valadoc.Api.Symbol {
			public ErrorCode (Valadoc.Api.ErrorDomain parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SourceComment? comment, string? cname, string? dbus_name, Vala.ErrorCode data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string get_cname ();
			public string get_dbus_name ();
		...
		public class ErrorDomain : Valadoc.Api.TypeSymbol {
			public ErrorDomain (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, string? cname, string? quark_macro_name, string? quark_function_name, string? dbus_name, Vala.ErrorDomain data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
			public string? get_dbus_name ();
		...
		public class Field : Valadoc.Api.Member {
			public Field (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, string? cname, bool is_static, bool is_volatile, Vala.Field data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
		...
		public class FormalParameter : Valadoc.Api.Symbol {
			public FormalParameter (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string? name, Valadoc.Api.SymbolAccessibility accessibility, Valadoc.Api.FormalParameterType type, bool ellipsis, Vala.Parameter data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public Valadoc.Content.Run default_value { get; set; }
		...
		public abstract class Member : Valadoc.Api.Symbol {
			public Member (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, Vala.Symbol data);
		}
		[CCode (cheader_filename = "valadoc.h")]
		public class Method : Valadoc.Api.Member, Valadoc.Api.Callable {
			public Method (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, string? cname, string? dbus_name, string? dbus_result_name, string? finish_function_cname, Valadoc.MethodBindingType binding_type, bool is_yields, bool is_dbus_visible, bool is_constructor, Vala.Method data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
			public string get_dbus_name ();
		...
		public abstract class Node : Valadoc.Api.Item, Valadoc.Api.Browsable, Valadoc.Documentation {
			...
			public Node (Valadoc.Api.Node? parent, Valadoc.Api.SourceFile? file, string? name, Vala.CodeNode? data);
		...
		public class Property : Valadoc.Api.Member {
			public Property (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, string? cname, string? dbus_name, bool is_dbus_visible, Valadoc.Api.PropertyBindingType binding_type, Vala.Property data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
			public string get_dbus_name ();
		...
		public class PropertyAccessor : Valadoc.Api.Symbol {
			public PropertyAccessor (Valadoc.Api.Property parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SymbolAccessibility accessibility, string? cname, Valadoc.Api.PropertyAccessorType type, Valadoc.Api.Ownership ownership, Vala.PropertyAccessor data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
		...
		public class Signal : Valadoc.Api.Member, Valadoc.Api.Callable {
			public Signal (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, string? cname, string? default_impl_cname, string? dbus_name, bool is_dbus_visible, bool is_virtual, Vala.Signal data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
			public string get_dbus_name ();
		...
		public abstract class Symbol : Valadoc.Api.Node {
			public Symbol (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string? name, Valadoc.Api.SymbolAccessibility accessibility, Vala.Symbol data);
		...
		public class TypeReference : Valadoc.Api.Item {
			public TypeReference (Valadoc.Api.Item parent, Valadoc.Api.Ownership ownership, bool pass_ownership, bool is_dynamic, bool is_nullable, string? dbus_type_signature, Vala.DataType? data);
		...
		public abstract class TypeSymbol : Valadoc.Api.Symbol {
			public TypeSymbol (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, string? type_macro_name, string? is_type_macro_name, string? type_cast_macro_name, string? type_function_name, bool is_basic_type, Vala.TypeSymbol data);
