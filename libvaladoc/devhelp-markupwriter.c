...
static void __lambda133_ (Block2Data* _data2_,
                   const gchar* str);
static void ___lambda133__valadoc_markup_writer_write_func (const gchar* text,
                                                     gpointer self);
...
static void
__lambda133_ (Block2Data* _data2_,
              const gchar* str)
{
	ValadocDevhelpMarkupWriter* self;
	self = _data2_->self;
...
static void
___lambda133__valadoc_markup_writer_write_func (const gchar* text,
                                                gpointer self)
{
	__lambda133_ (self, text);
}
                                         ...
                                         gboolean xml_declaration)
{
	...
	self = (ValadocDevhelpMarkupWriter*) valadoc_markup_writer_construct (object_type, ___lambda133__valadoc_markup_writer_write_func, block2_data_ref (_data2_), block2_data_unref, xml_declaration);
                                          ...
                                          const gchar* author)
{
	...
	_tmp15_ = _tmp14_;
	_tmp15__length1 = 14;
	valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) self, "book", _tmp15_, 14);
...
valadoc_devhelp_markup_writer_start_functions (ValadocDevhelpMarkupWriter* self)
{
	ValadocDevhelpMarkupWriter* result = NULL;
	g_return_val_if_fail (self != NULL, NULL);
	valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) self, "functions", NULL, 0);
	result = self;
	return result;
}
...
valadoc_devhelp_markup_writer_start_chapters (ValadocDevhelpMarkupWriter* self)
{
	ValadocDevhelpMarkupWriter* result = NULL;
	g_return_val_if_fail (self != NULL, NULL);
	valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) self, "chapters", NULL, 0);
	result = self;
	return result;
}
                                         ...
                                         const gchar* link)
{
	...
	_tmp5_ = _tmp4_;
	_tmp5__length1 = 4;
	valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) self, "sub", _tmp5_, 4);
                                       ...
                                       const gchar* link)
{
	...
	_tmp7_ = _tmp6_;
	_tmp7__length1 = 6;
	valadoc_markup_writer_start_tag ((ValadocMarkupWriter*) self, "keyword", _tmp7_, 6);
