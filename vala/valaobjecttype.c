                             ...
                             ValaCodeContext* context)
{
	...
	if (_tmp5_) {
		...
		_tmp12_ = _tmp11_;
		vala_report_error (_tmp12_, "too few type arguments");
		result = FALSE;
		return result;
	} else {
		...
		if (_tmp13_) {
			...
			_tmp20_ = _tmp19_;
			vala_report_error (_tmp20_, "too many type arguments");
			result = FALSE;
			return result;
		}
	}
	{
		...
		gint _tmp25_;
		gint _type_index = 0;
		_tmp21_ = vala_data_type_get_type_arguments ((ValaDataType*) self);
