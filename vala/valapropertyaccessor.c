...
"ual or override", _tmp103_);
	...
	if (_tmp108_ != NULL) {
		...
		_tmp110_ = _tmp109_;
		_tmp111_ = vala_property_get_is_abstract (_tmp110_);
		_tmp112_ = _tmp111_;
		_tmp106_ = _tmp112_;
	} else {
		_tmp106_ = FALSE;
	...
	if (_tmp106_) {
		...
		_tmp114_ = _tmp113_;
		_tmp115_ = vala_property_accessor_get_prop (self);
		_tmp116_ = _tmp115_;
		_tmp117_ = vala_symbol_get_full_name ((ValaSymbol*) _tmp116_);
		_tmp118_ = _tmp117_;
		_tmp119_ = g_strdup_printf ("Accessor of abstract property `%s' cannot have body", _tmp118_);
		_tmp120_ = _tmp119_;
		vala_report_error (_tmp114_, _tmp120_);
		_g_free0 (_tmp120_);
		_g_free0 (_tmp118_);
		result = FALSE;
		_vala_code_node_unref0 (old_symbol);
	...
	if (_tmp122_ != NULL) {
		...
		ValaBlock* _tmp134_;
		ValaBlock* _tmp135_;
		_tmp124_ = self->priv->_writable;
		if (_tmp124_) {
			_tmp123_ = TRUE;
		} else {
			gboolean _tmp125_;
			_tmp125_ = self->priv->_construction;
			_tmp123_ = _tmp125_;
		}
		if (_tmp123_) {
			ValaBlock* _tmp126_;
			...
			_tmp127_ = _tmp126_;
			_tmp128_ = vala_symbol_get_scope ((ValaSymbol*) _tmp127_);
			_tmp129_ = _tmp128_;
			_tmp130_ = self->priv->_value_parameter;
			_tmp131_ = vala_symbol_get_name ((ValaSymbol*) _tmp130_);
			_tmp132_ = _tmp131_;
			_tmp133_ = self->priv->_value_parameter;
			vala_scope_add (_tmp129_, _tmp132_, (ValaSymbol*) _tmp133_);
		}
		...
		vala_code_node_check ((ValaCodeNode*) _tmp135_, context);
		{
			...
			_tmp137_ = _tmp136_;
			_tmp138_ = vala_code_node_get_error_types ((ValaCodeNode*) _tmp137_);
			_body_error_type_list = _tmp138_;
			_tmp139_ = _body_error_type_list;
			_tmp140_ = vala_collection_get_size ((ValaCollection*) _tmp139_);
			_tmp141_ = _tmp140_;
			_body_error_type_size = _tmp141_;
			...
			while (TRUE) {
				...
				gboolean _tmp149_;
				gboolean _tmp150_;
				_tmp142_ = _body_error_type_index;
				_body_error_type_index = _tmp142_ + 1;
				_tmp143_ = _body_error_type_index;
				_tmp144_ = _body_error_type_size;
				if (!(_tmp143_ < _tmp144_)) {
					break;
				}
				_tmp145_ = _body_error_type_list;
				_tmp146_ = _body_error_type_index;
				_tmp147_ = vala_list_get (_tmp145_, _tmp146_);
				body_error_type = (ValaDataType*) _tmp147_;
				_tmp148_ = body_error_type;
				_tmp149_ = vala_error_type_get_dynamic_error (G_TYPE_CHECK_INSTANCE_CAST (_tmp148_, VALA_TYPE_ERROR_TYPE, ValaErrorType));
				_tmp150_ = _tmp149_;
				if (!_tmp150_) {
					...
					gchar* _tmp157_;
					gchar* _tmp158_;
					_tmp151_ = body_error_type;
					_tmp152_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp151_);
					_tmp153_ = _tmp152_;
					_tmp154_ = body_error_type;
					_tmp155_ = vala_code_node_to_string ((ValaCodeNode*) _tmp154_);
					_tmp156_ = _tmp155_;
					_tmp157_ = g_strdup_printf ("unhandled error `%s'", _tmp156_);
					_tmp158_ = _tmp157_;
					vala_report_warning (_tmp153_, _tmp158_);
					_g_free0 (_tmp158_);
					_g_free0 (_tmp156_);
				}
	...
	_tmp160_ = _tmp159_;
	_tmp161_ = old_symbol;
	vala_semantic_analyzer_set_current_symbol (_tmp160_, _tmp161_);
