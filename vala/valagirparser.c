	...
	if (_tmp56_) {
		...
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp64_, VALA_TYPE_CREATION_METHOD)) {
			...
			if (_tmp131_ != NULL) {
				...
				_tmp132_ = a;
				_tmp130_ = vala_attribute_has_argument (_tmp132_, "array_length");
			} else {
				_tmp130_ = FALSE;
			}
			if (_tmp130_) {
				...
				_tmp133_ = method;
				_tmp134_ = a;
				vala_code_node_set_attribute_bool ((ValaCodeNode*) _tmp133_, "CCode", "array_length", vala_attribute_get_bool (_tmp134_, "array_length", FALSE), NULL);
			}
			_tmp136_ = a;
			if (_tmp136_ != NULL) {
				ValaAttribute* _tmp137_;
				_tmp137_ = a;
				_tmp135_ = vala_attribute_has_argument (_tmp137_, "array_null_terminated");
			} else {
				_tmp135_ = FALSE;
			}
			if (_tmp135_) {
				...
				_tmp138_ = method;
				_tmp139_ = a;
				vala_code_node_set_attribute_bool ((ValaCodeNode*) _tmp138_, "CCode", "array_null_terminated", vala_attribute_get_bool (_tmp139_, "array_null_terminated", FALSE), NULL);
			}
			_vala_code_node_unref0 (a);
		}
		_tmp140_ = method;
		_tmp141_ = finish_method;
		vala_code_node_copy_attribute_double ((ValaCodeNode*) _tmp140_, (ValaCodeNode*) _tmp141_, "CCode", "async_result_pos");
		{
			ValaList* _param_list = NULL;
			ValaMethod* _tmp142_;
			ValaList* _tmp143_;
			...
			while (TRUE) {
				...
				ValaParameterDirection _tmp155_;
				...
				_tmp155_ = _tmp154_;
				if (_tmp155_ == VALA_PARAMETER_DIRECTION_OUT) {
					...
					_tmp156_ = param;
					_tmp157_ = vala_parameter_copy (_tmp156_);
					async_param = _tmp157_;
					_tmp158_ = method;
					_tmp159_ = vala_symbol_get_scope ((ValaSymbol*) _tmp158_);
					_tmp160_ = _tmp159_;
					_tmp161_ = param;
					_tmp162_ = vala_symbol_get_name ((ValaSymbol*) _tmp161_);
					_tmp163_ = _tmp162_;
					_tmp164_ = vala_scope_lookup (_tmp160_, _tmp163_);
					_tmp165_ = _tmp164_;
					_tmp166_ = _tmp165_ != NULL;
					...
					if (_tmp166_) {
						...
						gchar* _tmp171_;
						gchar* _tmp172_;
						_tmp167_ = async_param;
						_tmp168_ = async_param;
						_tmp169_ = vala_symbol_get_name ((ValaSymbol*) _tmp168_);
						_tmp170_ = _tmp169_;
						_tmp171_ = g_strconcat (_tmp170_, "_out", NULL);
						_tmp172_ = _tmp171_;
					...
					vala_callable_add_parameter ((ValaCallable*) _tmp173_, _tmp174_);
		...
		}
		{
			...
			while (TRUE) {
				...
				_tmp186_ = method;
				_tmp187_ = error_type;
				_tmp188_ = vala_data_type_copy (_tmp187_);
				_tmp189_ = _tmp188_;
				vala_code_node_add_error_type ((ValaCodeNode*) _tmp186_, _tmp189_);
				_vala_code_node_unref0 (_tmp189_);
				_vala_code_node_unref0 (error_type);
			}
			_vala_iterable_unref0 (_error_type_list);
		}
		_tmp190_ = finish_method_node;
		_tmp190_->processed = TRUE;
		_tmp191_ = finish_method_node;
