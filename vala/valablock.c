                       ...
                       ValaCodeContext* context)
{
	...
	}
	{
		...
		gint _tmp37_;
		gint _local_index = 0;
		_tmp34_ = vala_block_get_local_variables (self);
		_local_list = _tmp34_;
		_tmp35_ = _local_list;
	...
	}
	{
		...
		_tmp45_ = self->priv->local_constants;
		_tmp46_ = _vala_iterable_ref0 (_tmp45_);
		_constant_list = _tmp46_;
		_tmp47_ = _constant_list;
		_tmp48_ = vala_collection_get_size ((ValaCollection*) _tmp47_);
		_tmp49_ = _tmp48_;
		_constant_size = _tmp49_;
		_constant_index = -1;
		while (TRUE) {
			gint _tmp50_;
			gint _tmp51_;
			...
			_tmp50_ = _constant_index;
			_constant_index = _tmp50_ + 1;
			_tmp51_ = _constant_index;
			_tmp52_ = _constant_size;
			if (!(_tmp51_ < _tmp52_)) {
				break;
			}
			_tmp53_ = _constant_list;
			_tmp54_ = _constant_index;
			_tmp55_ = vala_list_get (_tmp53_, _tmp54_);
			constant = (ValaConstant*) _tmp55_;
			_tmp56_ = constant;
	...
	}
	{
		...
		gint _tmp60_;
		gint _stmt_index = 0;
		_tmp57_ = vala_block_get_statements (self);
		_stmt_list = _tmp57_;
		_tmp58_ = _stmt_list;
