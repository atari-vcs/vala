                                                   ...
                                                   ValaCCodeFile* decl_space)
{
	...
	if (is_gtypeinstance) {
		...
		_g_free0 (_tmp73_);
		_g_free0 (_tmp71_);
		_tmp75_ = vala_get_ccode_type_get_function ((ValaObjectTypeSymbol*) cl);
		_tmp76_ = _tmp75_;
	...
	if (is_gtypeinstance) {
		...
		ValaCCodeTypeDefinition* _tmp239_;
		ValaCCodeTypeDefinition* _tmp240_;
		ValaClassRegisterFunction* type_fun = NULL;
		ValaClassRegisterFunction* _tmp241_;
		ValaClassRegisterFunction* _tmp242_;
		ValaCodeContext* _tmp243_;
		ValaCodeContext* _tmp244_;
		ValaClassRegisterFunction* _tmp245_;
		ValaCCodeFragment* _tmp246_;
		ValaCCodeFragment* _tmp247_;
		_tmp231_ = vala_get_ccode_type_name ((ValaObjectTypeSymbol*) cl);
		_tmp232_ = _tmp231_;
		_tmp233_ = g_strdup_printf ("struct _%s", _tmp232_);
		_tmp234_ = _tmp233_;
		_tmp235_ = vala_get_ccode_type_name ((ValaObjectTypeSymbol*) cl);
		_tmp236_ = _tmp235_;
		_tmp237_ = vala_ccode_variable_declarator_new (_tmp236_, NULL, NULL);
		_tmp238_ = _tmp237_;
		_tmp239_ = vala_ccode_type_definition_new (_tmp234_, (ValaCCodeDeclarator*) _tmp238_);
		_tmp240_ = _tmp239_;
		vala_ccode_file_add_type_declaration (decl_space, (ValaCCodeNode*) _tmp240_);
		_vala_ccode_node_unref0 (_tmp240_);
		_vala_ccode_node_unref0 (_tmp238_);
		_g_free0 (_tmp236_);
		_g_free0 (_tmp234_);
		_g_free0 (_tmp232_);
		_tmp241_ = vala_class_register_function_new (cl);
		type_fun = _tmp241_;
		_tmp242_ = type_fun;
		_tmp243_ = vala_ccode_base_module_get_context ((ValaCCodeBaseModule*) self);
		_tmp244_ = _tmp243_;
		vala_typeregister_function_init_from_type ((ValaTypeRegisterFunction*) _tmp242_, _tmp244_, ((ValaCCodeBaseModule*) self)->in_plugin, TRUE);
		_tmp245_ = type_fun;
		_tmp246_ = vala_typeregister_function_get_declaration ((ValaTypeRegisterFunction*) _tmp245_);
		_tmp247_ = _tmp246_;
		vala_ccode_file_add_type_member_declaration (decl_space, (ValaCCodeNode*) _tmp247_);
		_vala_ccode_node_unref0 (_tmp247_);
		_vala_typeregister_function_unref0 (type_fun);
	}
	_tmp248_ = _vala_code_node_ref0 (cl);
	base_class = _tmp248_;
	while (TRUE) {
		ValaClass* _tmp249_;
		ValaClass* _tmp250_;
		...
		ValaClass* _tmp255_;
		_tmp249_ = base_class;
		_tmp250_ = vala_class_get_base_class (_tmp249_);
		_tmp251_ = _tmp250_;
		if (!(_tmp251_ != NULL)) {
			break;
		}
		...
		_tmp254_ = _tmp253_;
		_tmp255_ = _vala_code_node_ref0 (_tmp254_);
		_vala_code_node_unref0 (base_class);
		base_class = _tmp255_;
	}
	_tmp258_ = base_class;
	_tmp259_ = vala_class_get_is_compact (_tmp258_);
	_tmp260_ = _tmp259_;
	if (_tmp260_) {
		ValaClass* _tmp261_;
		_tmp261_ = base_class;
		_tmp257_ = vala_is_reference_counting ((ValaTypeSymbol*) _tmp261_);
	} else {
		_tmp257_ = FALSE;
	}
	if (!_tmp257_) {
		...
		_tmp264_ = _tmp263_;
		_tmp265_ = vala_code_context_get_use_header (_tmp264_);
		_tmp266_ = _tmp265_;
		if (!_tmp266_) {
			_tmp262_ = TRUE;
		} else {
			gboolean _tmp267_;
			gboolean _tmp268_;
			_tmp267_ = vala_ccode_file_get_is_header (decl_space);
			_tmp268_ = _tmp267_;
			_tmp262_ = _tmp268_;
		}
		_tmp256_ = _tmp262_;
	...
	if (_tmp256_) {
		...
		ValaCCodeNewline* _tmp286_;
		ValaCCodeNewline* _tmp287_;
		_tmp269_ = base_class;
		if (vala_is_reference_counting ((ValaTypeSymbol*) _tmp269_)) {
			ValaClass* _tmp270_;
			gchar* _tmp271_;
			_tmp270_ = base_class;
			_tmp271_ = vala_get_ccode_unref_function ((ValaObjectTypeSymbol*) _tmp270_);
			...
			gchar* _tmp273_;
			_tmp272_ = base_class;
			_tmp273_ = vala_get_ccode_free_function ((ValaTypeSymbol*) _tmp272_);
			_g_free0 (autoptr_cleanup_func);
		...
		if (_tmp274_) {
			...
			_tmp277_ = vala_code_node_get_source_reference ((ValaCodeNode*) cl);
			_tmp278_ = _tmp277_;
			vala_report_error (_tmp278_, "internal error: autoptr_cleanup_func not available");
		}
		_tmp279_ = vala_get_ccode_name ((ValaCodeNode*) cl);
		_tmp280_ = _tmp279_;
		...
		_g_free0 (_tmp283_);
		_g_free0 (_tmp280_);
		_tmp286_ = vala_ccode_newline_new ();
		_tmp287_ = _tmp286_;
		vala_ccode_file_add_type_member_declaration (decl_space, (ValaCCodeNode*) _tmp287_);
                                                      ...
                                                      ValaCCodeFile* decl_space)
{
	...
	if (is_gtypeinstance) {
		...
		if (_tmp133_) {
			...
			_tmp142_ = _tmp141_;
			_tmp143_ = g_strdup_printf ("%sClassPrivate", _tmp142_);
			_tmp144_ = _tmp143_;
		...
		if (_tmp205_) {
			...
			_tmp210_ = _tmp209_;
			_tmp211_ = vala_get_ccode_name ((ValaCodeNode*) cl);
			_tmp212_ = _tmp211_;
			_tmp213_ = g_strdup_printf ("(G_TYPE_CLASS_GET_PRIVATE (klass, %s, %sClassPrivate))", _tmp210_, _tmp212_);
			_tmp214_ = _tmp213_;
			_g_free0 (_tmp212_);
			_g_free0 (_tmp210_);
			macro = _tmp214_;
                                    ...
                                    ValaClass* cl)
{
	...
	gchar* _tmp59_;
	gchar* _tmp60_;
	ValaCCodeStruct* _tmp359_;
	ValaCCodeStruct* _tmp360_;
	ValaCCodeEnum* _tmp361_;
	...
	if (is_gtypeinstance) {
		...
		gint _tmp140_;
		gint _tmp141_;
		ValaConstructor* _tmp173_;
		ValaConstructor* _tmp174_;
		...
		gboolean _tmp195_;
		gboolean _tmp196_;
		ValaComment* _tmp204_;
		ValaComment* _tmp205_;
		ValaClassRegisterFunction* type_fun = NULL;
		ValaClassRegisterFunction* _tmp213_;
		...
		if (_tmp141_ > 0) {
			...
			gchar* _tmp144_;
			gchar* _tmp145_;
			ValaCCodeEnum* _tmp146_;
			const gchar* _tmp147_;
			ValaCCodeEnumValue* _tmp148_;
			ValaCCodeEnumValue* _tmp149_;
			...
			ValaCCodeDeclaratorSuffix* _tmp167_;
			ValaCCodeDeclaratorSuffix* _tmp168_;
			...
			_tmp142_ = vala_get_ccode_upper_case_name ((ValaSymbol*) cl, NULL);
			_tmp143_ = _tmp142_;
			_tmp144_ = g_strdup_printf ("%s_NUM_SIGNALS", _tmp143_);
			_tmp145_ = _tmp144_;
			_g_free0 (_tmp143_);
			last_signal = _tmp145_;
			_tmp146_ = ((ValaCCodeBaseModule*) self)->signal_enum;
			_tmp147_ = last_signal;
			_tmp148_ = vala_ccode_enum_value_new (_tmp147_, NULL);
			_tmp149_ = _tmp148_;
			vala_ccode_enum_add_value (_tmp146_, _tmp149_);
			_vala_ccode_node_unref0 (_tmp149_);
			_tmp150_ = ((ValaCCodeBaseModule*) self)->cfile;
			_tmp151_ = ((ValaCCodeBaseModule*) self)->signal_enum;
			vala_ccode_file_add_type_declaration (_tmp150_, (ValaCCodeNode*) _tmp151_);
			_tmp152_ = vala_ccode_declaration_new ("guint");
			signal_array_decl = _tmp152_;
			_tmp153_ = signal_array_decl;
			_tmp154_ = signal_array_decl;
			_tmp155_ = vala_ccode_node_get_modifiers ((ValaCCodeNode*) _tmp154_);
			_tmp156_ = _tmp155_;
			vala_ccode_node_set_modifiers ((ValaCCodeNode*) _tmp154_, _tmp156_ | VALA_CCODE_MODIFIERS_STATIC);
			_tmp157_ = signal_array_decl;
			_tmp158_ = vala_get_ccode_lower_case_name ((ValaCodeNode*) cl, NULL);
			_tmp159_ = _tmp158_;
			_tmp160_ = g_strdup_printf ("%s_signals", _tmp159_);
			_tmp161_ = _tmp160_;
			_tmp162_ = vala_ccode_constant_new ("{0}");
			_tmp163_ = _tmp162_;
			_tmp164_ = last_signal;
			_tmp165_ = vala_ccode_identifier_new (_tmp164_);
			_tmp166_ = _tmp165_;
			_tmp167_ = vala_ccode_declarator_suffix_new_with_array ((ValaCCodeExpression*) _tmp166_);
			_tmp168_ = _tmp167_;
			_tmp169_ = vala_ccode_variable_declarator_new (_tmp161_, (ValaCCodeExpression*) _tmp163_, _tmp168_);
			_tmp170_ = _tmp169_;
			vala_ccode_declaration_add_declarator (_tmp157_, (ValaCCodeDeclarator*) _tmp170_);
			_vala_ccode_node_unref0 (_tmp170_);
			_vala_ccode_declarator_suffix_unref0 (_tmp168_);
			_vala_ccode_node_unref0 (_tmp166_);
		...
		}
		{
			...
			gint _tmp183_;
			gint _base_type_index = 0;
			_tmp179_ = vala_class_get_base_types (cl);
			...
			while (TRUE) {
				...
				_tmp187_ = vala_list_get (_tmp186_, _base_type_index);
				base_type = (ValaDataType*) _tmp187_;
				_tmp188_ = base_type;
				_tmp189_ = vala_data_type_get_type_symbol (_tmp188_);
				_tmp190_ = _tmp189_;
				if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp190_, VALA_TYPE_INTERFACE)) {
					ValaDataType* _tmp191_;
					ValaTypeSymbol* _tmp192_;
					ValaTypeSymbol* _tmp193_;
					_tmp191_ = base_type;
					_tmp192_ = vala_data_type_get_type_symbol (_tmp191_);
					_tmp193_ = _tmp192_;
					vala_gtype_module_add_interface_init_function (self, cl, G_TYPE_CHECK_INSTANCE_CAST (_tmp193_, VALA_TYPE_INTERFACE, ValaInterface));
				}
				_vala_code_node_unref0 (base_type);
			}
			_vala_iterable_unref0 (_base_type_list);
		...
		_tmp195_ = vala_class_get_is_compact (cl);
		_tmp196_ = _tmp195_;
		if (!_tmp196_) {
			...
			gint _tmp200_;
			gint _tmp201_;
			_tmp199_ = vala_object_type_symbol_get_fields ((ValaObjectTypeSymbol*) cl);
			...
			if (_tmp201_ > 0) {
				...
				_tmp202_ = vala_class_get_destructor (cl);
				_tmp203_ = _tmp202_;
			...
			if (_tmp198_) {
				...
				_tmp197_ = vala_class_is_fundamental (cl);
			}
			_tmp194_ = _tmp197_;
		} else {
			_tmp194_ = FALSE;
		...
		_tmp204_ = vala_symbol_get_comment ((ValaSymbol*) cl);
		_tmp205_ = _tmp204_;
		if (_tmp205_ != NULL) {
			ValaCCodeFile* _tmp206_;
			ValaComment* _tmp207_;
			ValaComment* _tmp208_;
			const gchar* _tmp209_;
			const gchar* _tmp210_;
			ValaCCodeComment* _tmp211_;
			ValaCCodeComment* _tmp212_;
			_tmp206_ = ((ValaCCodeBaseModule*) self)->cfile;
			_tmp207_ = vala_symbol_get_comment ((ValaSymbol*) cl);
			_tmp208_ = _tmp207_;
			_tmp209_ = vala_comment_get_content (_tmp208_);
			_tmp210_ = _tmp209_;
			_tmp211_ = vala_ccode_comment_new (_tmp210_);
			_tmp212_ = _tmp211_;
			vala_ccode_file_add_type_member_definition (_tmp206_, (ValaCCodeNode*) _tmp212_);
			_vala_ccode_node_unref0 (_tmp212_);
		}
		_tmp213_ = vala_class_register_function_new (cl);
		type_fun = _tmp213_;
		_tmp214_ = type_fun;
		_tmp215_ = vala_ccode_base_module_get_context ((ValaCCodeBaseModule*) self);
		_tmp216_ = _tmp215_;
		vala_typeregister_function_init_from_type ((ValaTypeRegisterFunction*) _tmp214_, _tmp216_, ((ValaCCodeBaseModule*) self)->in_plugin, FALSE);
		_tmp217_ = ((ValaCCodeBaseModule*) self)->cfile;
		_tmp218_ = type_fun;
		_tmp219_ = vala_typeregister_function_get_source_declaration ((ValaTypeRegisterFunction*) _tmp218_);
		_tmp220_ = _tmp219_;
		vala_ccode_file_add_type_member_declaration (_tmp217_, (ValaCCodeNode*) _tmp220_);
		_vala_ccode_node_unref0 (_tmp220_);
		_tmp221_ = ((ValaCCodeBaseModule*) self)->cfile;
		_tmp222_ = type_fun;
		_tmp223_ = vala_typeregister_function_get_definition ((ValaTypeRegisterFunction*) _tmp222_);
		_tmp224_ = _tmp223_;
		vala_ccode_file_add_type_member_definition (_tmp221_, (ValaCCodeNode*) _tmp224_);
		...
		if (is_fundamental) {
			...
			ValaCCodeCastExpression* _tmp341_;
			...
			_tmp226_ = _tmp225_;
			_tmp227_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp226_, "ref_count");
			_tmp228_ = _tmp227_;
			_vala_ccode_node_unref0 (_tmp226_);
			ref_count = _tmp228_;
			_tmp229_ = vala_get_ccode_ref_function ((ValaTypeSymbol*) cl);
			_tmp230_ = _tmp229_;
			_tmp231_ = vala_ccode_function_new (_tmp230_, "gpointer");
			_tmp232_ = _tmp231_;
			_g_free0 (_tmp230_);
			ref_fun = _tmp232_;
			_tmp233_ = ref_fun;
			_tmp234_ = vala_ccode_parameter_new ("instance", "gpointer");
			_tmp235_ = _tmp234_;
			vala_ccode_function_add_parameter (_tmp233_, _tmp235_);
			...
			_tmp243_ = ref_fun;
			vala_ccode_base_module_push_function ((ValaCCodeBaseModule*) self, _tmp243_);
			...
			_tmp249_ = _tmp248_;
			_tmp250_ = vala_ccode_identifier_new ("instance");
			_tmp251_ = _tmp250_;
			_tmp252_ = vala_ccode_variable_declarator_new ("self", (ValaCCodeExpression*) _tmp251_, NULL);
			_tmp253_ = _tmp252_;
			vala_ccode_function_add_declaration (_tmp245_, _tmp249_, (ValaCCodeDeclarator*) _tmp253_, 0);
			_vala_ccode_node_unref0 (_tmp253_);
			_vala_ccode_node_unref0 (_tmp251_);
			_g_free0 (_tmp249_);
			_g_free0 (_tmp247_);
			_tmp254_ = vala_ccode_identifier_new ("g_atomic_int_inc");
			_tmp255_ = _tmp254_;
			...
			_tmp261_ = _tmp260_;
			vala_ccode_function_call_add_argument (_tmp258_, (ValaCCodeExpression*) _tmp261_);
			_vala_ccode_node_unref0 (_tmp261_);
			_tmp262_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
			_tmp263_ = _tmp262_;
			_tmp264_ = ccall;
			vala_ccode_function_add_expression (_tmp263_, (ValaCCodeExpression*) _tmp264_);
			_tmp265_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
			_tmp266_ = _tmp265_;
			_tmp267_ = vala_ccode_identifier_new ("instance");
			_tmp268_ = _tmp267_;
			vala_ccode_function_add_return (_tmp266_, (ValaCCodeExpression*) _tmp268_);
			_vala_ccode_node_unref0 (_tmp268_);
			vala_ccode_base_module_pop_function ((ValaCCodeBaseModule*) self);
			_tmp269_ = ((ValaCCodeBaseModule*) self)->cfile;
			_tmp270_ = ref_fun;
			vala_ccode_file_add_function (_tmp269_, _tmp270_);
			_tmp271_ = vala_get_ccode_unref_function ((ValaObjectTypeSymbol*) cl);
			_tmp272_ = _tmp271_;
			...
			unref_fun = _tmp274_;
			_tmp275_ = unref_fun;
			_tmp276_ = vala_ccode_parameter_new ("instance", "gpointer");
			_tmp277_ = _tmp276_;
			vala_ccode_function_add_parameter (_tmp275_, _tmp277_);
			_vala_ccode_node_unref0 (_tmp277_);
			if (vala_symbol_is_private_symbol ((ValaSymbol*) cl)) {
				ValaCCodeFunction* _tmp278_;
				_tmp278_ = unref_fun;
				vala_ccode_node_set_modifiers ((ValaCCodeNode*) _tmp278_, VALA_CCODE_MODIFIERS_STATIC);
			} else {
				...
				gboolean _tmp282_;
				gboolean _tmp283_;
				_tmp280_ = vala_ccode_base_module_get_context ((ValaCCodeBaseModule*) self);
				_tmp281_ = _tmp280_;
				_tmp282_ = vala_code_context_get_hide_internal (_tmp281_);
				_tmp283_ = _tmp282_;
				if (_tmp283_) {
					_tmp279_ = vala_symbol_is_internal_symbol ((ValaSymbol*) cl);
				} else {
					_tmp279_ = FALSE;
				}
				if (_tmp279_) {
					...
					_tmp284_ = unref_fun;
					vala_ccode_node_set_modifiers ((ValaCCodeNode*) _tmp284_, VALA_CCODE_MODIFIERS_INTERNAL);
				}
			}
			_tmp285_ = unref_fun;
			vala_ccode_base_module_push_function ((ValaCCodeBaseModule*) self, _tmp285_);
			_tmp286_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
			_tmp287_ = _tmp286_;
			_tmp288_ = vala_get_ccode_name ((ValaCodeNode*) cl);
			_tmp289_ = _tmp288_;
			_tmp290_ = g_strdup_printf ("%s *", _tmp289_);
			_tmp291_ = _tmp290_;
			_tmp292_ = vala_ccode_identifier_new ("instance");
			_tmp293_ = _tmp292_;
			_tmp294_ = vala_ccode_variable_declarator_new ("self", (ValaCCodeExpression*) _tmp293_, NULL);
			_tmp295_ = _tmp294_;
			vala_ccode_function_add_declaration (_tmp287_, _tmp291_, (ValaCCodeDeclarator*) _tmp295_, 0);
			_vala_ccode_node_unref0 (_tmp295_);
			_vala_ccode_node_unref0 (_tmp293_);
			_g_free0 (_tmp291_);
			_g_free0 (_tmp289_);
			_tmp296_ = vala_ccode_identifier_new ("g_atomic_int_dec_and_test");
			_tmp297_ = _tmp296_;
			...
			_tmp302_ = _tmp301_;
			vala_ccode_function_call_add_argument (_tmp299_, (ValaCCodeExpression*) _tmp302_);
			_vala_ccode_node_unref0 (_tmp302_);
			_tmp303_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
			_tmp304_ = _tmp303_;
			_tmp305_ = ccall;
			vala_ccode_function_open_if (_tmp304_, (ValaCCodeExpression*) _tmp305_);
			_tmp306_ = vala_get_ccode_type_get_function ((ValaObjectTypeSymbol*) cl);
			_tmp307_ = _tmp306_;
			...
			_tmp315_ = vala_get_ccode_type_get_function ((ValaObjectTypeSymbol*) cl);
			_tmp316_ = _tmp315_;
			...
			ccast = _tmp320_;
			_tmp321_ = ccast;
			_tmp322_ = vala_ccode_identifier_new ("self");
			_tmp323_ = _tmp322_;
			vala_ccode_function_call_add_argument (_tmp321_, (ValaCCodeExpression*) _tmp323_);
			_vala_ccode_node_unref0 (_tmp323_);
			_tmp324_ = ccast;
			_tmp325_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp324_, "finalize");
			_tmp326_ = _tmp325_;
			...
			_tmp332_ = _tmp331_;
			_tmp333_ = ccall;
			vala_ccode_function_add_expression (_tmp332_, (ValaCCodeExpression*) _tmp333_);
			_tmp334_ = vala_ccode_identifier_new ("g_type_free_instance");
			_tmp335_ = _tmp334_;
			...
			_tmp340_ = _tmp339_;
			_tmp341_ = vala_ccode_cast_expression_new ((ValaCCodeExpression*) _tmp340_, "GTypeInstance *");
			_tmp342_ = _tmp341_;
			vala_ccode_function_call_add_argument (_tmp338_, (ValaCCodeExpression*) _tmp342_);
			...
			_tmp347_ = _tmp346_;
			vala_ccode_function_close (_tmp347_);
			vala_ccode_base_module_pop_function ((ValaCCodeBaseModule*) self);
			_tmp348_ = ((ValaCCodeBaseModule*) self)->cfile;
			_tmp349_ = unref_fun;
			vala_ccode_file_add_function (_tmp348_, _tmp349_);
		...
		gboolean _tmp352_;
		gboolean _tmp353_;
		_tmp352_ = vala_class_get_is_compact (cl);
		_tmp353_ = _tmp352_;
		if (_tmp353_) {
			_tmp351_ = TRUE;
		} else {
			ValaClass* _tmp354_;
			ValaClass* _tmp355_;
			_tmp354_ = vala_class_get_base_class (cl);
			_tmp355_ = _tmp354_;
		...
		if (_tmp351_) {
			...
			ValaClass* _tmp357_;
			ValaClass* _tmp358_;
			_tmp356_ = vala_class_get_base_class (cl);
			_tmp357_ = _tmp356_;
			_tmp358_ = ((ValaCCodeBaseModule*) self)->gsource_type;
                                             ...
                                             ValaClass* cl)
{
	...
	if (_tmp52_) {
		...
		_tmp75_ = vala_get_ccode_name ((ValaCodeNode*) _tmp74_);
		_tmp76_ = _tmp75_;
		_tmp77_ = g_strdup_printf ("%sClass *", _tmp76_);
		_tmp78_ = _tmp77_;
	...
	}
	{
		...
		while (TRUE) {
			...
			_tmp215_ = _tmp214_;
			_tmp216_ = vala_get_ccode_name ((ValaCodeNode*) cl);
			_tmp217_ = _tmp216_;
			_tmp218_ = g_strdup_printf ("%sClass *", _tmp217_);
			_tmp219_ = _tmp218_;
                                               ...
                                               ValaInterface* iface)
{
	...
	ValaMapIterator* _tmp199_;
	ValaMapIterator* _tmp200_;
	...
	if (_tmp147_ != NULL) {
		{
			...
			while (TRUE) {
				...
				_tmp183_ = vala_ccode_base_module_get_dup_func_expression ((ValaCCodeBaseModule*) self, _tmp182_, NULL, FALSE);
				_tmp184_ = _tmp183_;
				_tmp185_ = p;
				vala_gtype_module_add_generic_accessor_function (self, _tmp181_, "GBoxedCopyFunc", _tmp184_, _tmp185_, cl, iface);
				_vala_ccode_node_unref0 (_tmp184_);
				_g_free0 (_tmp181_);
				_g_free0 (_tmp179_);
				_tmp186_ = p;
				...
				_tmp194_ = vala_ccode_base_module_get_destroy_func_expression ((ValaCCodeBaseModule*) self, _tmp193_, FALSE);
				_tmp195_ = _tmp194_;
				_tmp196_ = p;
				vala_gtype_module_add_generic_accessor_function (self, _tmp192_, "GDestroyNotify", _tmp195_, _tmp196_, cl, iface);
	...
	_tmp197_ = vala_class_get_implicit_implementations (cl);
	_tmp198_ = _tmp197_;
	_tmp199_ = vala_map_map_iterator ((ValaMap*) _tmp198_);
	_tmp200_ = _tmp199_;
	_vala_map_unref0 (_tmp198_);
	it = _tmp200_;
	while (TRUE) {
		...
		ValaSymbol* _tmp206_;
		_tmp201_ = it;
		if (!vala_map_iterator_next (_tmp201_)) {
			break;
		}
		_tmp202_ = it;
		_tmp203_ = vala_map_iterator_get_key (_tmp202_);
		m = (ValaMethod*) _tmp203_;
		_tmp204_ = m;
		_tmp205_ = vala_symbol_get_parent_symbol ((ValaSymbol*) _tmp204_);
		_tmp206_ = _tmp205_;
		if (_tmp206_ == G_TYPE_CHECK_INSTANCE_CAST (iface, VALA_TYPE_SYMBOL, ValaSymbol)) {
			ValaMethod* base_method = NULL;
			ValaMapIterator* _tmp207_;
			gpointer _tmp208_;
			ValaMethod* _tmp209_;
			...
			_tmp207_ = it;
			_tmp208_ = vala_map_iterator_get_value (_tmp207_);
			base_method = (ValaMethod*) _tmp208_;
			_tmp209_ = base_method;
			_tmp210_ = ((ValaCCodeBaseModule*) self)->cfile;
			vala_ccode_base_module_generate_method_declaration ((ValaCCodeBaseModule*) self, _tmp209_, _tmp210_);
			_tmp211_ = base_method;
			_tmp212_ = vala_get_ccode_name ((ValaCodeNode*) _tmp211_);
			_tmp213_ = _tmp212_;
			...
			_tmp216_ = m;
			_tmp217_ = cfunc;
			_tmp218_ = vala_gtype_module_cast_method_pointer (self, _tmp216_, _tmp217_, (ValaObjectTypeSymbol*) iface, 3);
			_vala_ccode_node_unref0 (cfunc);
			cfunc = _tmp218_;
			_tmp219_ = vala_ccode_identifier_new ("iface");
			ciface = _tmp219_;
			_tmp220_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
			_tmp221_ = _tmp220_;
			_tmp222_ = ciface;
			_tmp223_ = m;
			_tmp224_ = vala_get_ccode_vfunc_name (_tmp223_);
			_tmp225_ = _tmp224_;
			_tmp226_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp222_, _tmp225_);
			_tmp227_ = _tmp226_;
			_tmp228_ = cfunc;
			vala_ccode_function_add_assignment (_tmp221_, (ValaCCodeExpression*) _tmp227_, _tmp228_);
	...
	}
	{
		...
		gint _tmp233_;
		gint _prop_index = 0;
		_tmp229_ = vala_object_type_symbol_get_properties ((ValaObjectTypeSymbol*) cl);
		...
		while (TRUE) {
			...
			_tmp236_ = _prop_list;
			_tmp237_ = vala_list_get (_tmp236_, _prop_index);
			prop = (ValaProperty*) _tmp237_;
			_tmp238_ = prop;
			_tmp239_ = vala_property_get_base_interface_property (_tmp238_);
			_tmp240_ = _tmp239_;
			if (_tmp240_ == NULL) {
				_vala_code_node_unref0 (prop);
				continue;
			...
			base_type = _tmp246_;
			_tmp247_ = base_type;
			if (_tmp247_ != G_TYPE_CHECK_INSTANCE_CAST (iface, VALA_TYPE_OBJECT_TYPE_SYMBOL, ValaObjectTypeSymbol)) {
				_vala_code_node_unref0 (base_type);
				_vala_code_node_unref0 (prop);
				continue;
			}
			_tmp248_ = vala_ccode_identifier_new ("iface");
			ciface = _tmp248_;
			_tmp250_ = prop;
			_tmp251_ = vala_property_get_base_interface_property (_tmp250_);
			_tmp252_ = _tmp251_;
			if (!vala_get_ccode_no_accessor_method (_tmp252_)) {
				ValaProperty* _tmp253_;
				...
				_tmp255_ = _tmp254_;
				_tmp249_ = !vala_get_ccode_concrete_accessor (_tmp255_);
			} else {
				_tmp249_ = FALSE;
			}
			if (_tmp249_) {
				...
				_tmp256_ = prop;
				_tmp257_ = vala_property_get_get_accessor (_tmp256_);
				_tmp258_ = _tmp257_;
				if (_tmp258_ != NULL) {
					...
					_tmp259_ = prop;
					_tmp260_ = vala_property_get_base_interface_property (_tmp259_);
					_tmp261_ = _tmp260_;
					_tmp262_ = vala_property_get_get_accessor (_tmp261_);
					_tmp263_ = _tmp262_;
					_tmp264_ = ((ValaCCodeBaseModule*) self)->cfile;
					vala_ccode_base_module_generate_property_accessor_declaration ((ValaCCodeBaseModule*) self, _tmp263_, _tmp264_);
					_tmp265_ = prop;
					_tmp266_ = vala_property_get_get_accessor (_tmp265_);
					_tmp267_ = _tmp266_;
					_tmp268_ = vala_get_ccode_real_name ((ValaSymbol*) _tmp267_);
					cname = _tmp268_;
					_tmp270_ = prop;
					_tmp271_ = vala_property_get_is_abstract (_tmp270_);
					_tmp272_ = _tmp271_;
					if (_tmp272_) {
						_tmp269_ = TRUE;
					} else {
						...
						gboolean _tmp275_;
						_tmp273_ = prop;
						_tmp274_ = vala_property_get_is_virtual (_tmp273_);
						_tmp275_ = _tmp274_;
						_tmp269_ = _tmp275_;
					}
					if (_tmp269_) {
						...
						_tmp278_ = _tmp277_;
						_tmp279_ = vala_get_ccode_name ((ValaCodeNode*) _tmp278_);
						_g_free0 (cname);
						cname = _tmp279_;
					}
					_tmp280_ = cname;
					_tmp281_ = vala_ccode_identifier_new (_tmp280_);
					cfunc = (ValaCCodeExpression*) _tmp281_;
					_tmp283_ = prop;
					_tmp284_ = vala_property_get_is_abstract (_tmp283_);
					_tmp285_ = _tmp284_;
					if (_tmp285_) {
						_tmp282_ = TRUE;
					} else {
						...
						gboolean _tmp288_;
						_tmp286_ = prop;
						_tmp287_ = vala_property_get_is_virtual (_tmp286_);
						_tmp288_ = _tmp287_;
						_tmp282_ = _tmp288_;
					}
					if (_tmp282_) {
						...
						_tmp292_ = cfunc;
						_tmp293_ = base_type;
						_tmp294_ = vala_gtype_module_cast_property_accessor_pointer (self, _tmp291_, _tmp292_, _tmp293_);
						_vala_ccode_node_unref0 (cfunc);
						cfunc = _tmp294_;
					}
					...
					_tmp297_ = ciface;
					_tmp298_ = prop;
					_tmp299_ = vala_symbol_get_name ((ValaSymbol*) _tmp298_);
					_tmp300_ = _tmp299_;
					_tmp301_ = g_strdup_printf ("get_%s", _tmp300_);
					_tmp302_ = _tmp301_;
					_tmp303_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp297_, _tmp302_);
					_tmp304_ = _tmp303_;
					_tmp305_ = cfunc;
					vala_ccode_function_add_assignment (_tmp296_, (ValaCCodeExpression*) _tmp304_, _tmp305_);
				...
				if (_tmp308_ != NULL) {
					...
					_tmp309_ = prop;
					_tmp310_ = vala_property_get_base_interface_property (_tmp309_);
					_tmp311_ = _tmp310_;
					_tmp312_ = vala_property_get_set_accessor (_tmp311_);
					_tmp313_ = _tmp312_;
					_tmp314_ = ((ValaCCodeBaseModule*) self)->cfile;
					vala_ccode_base_module_generate_property_accessor_declaration ((ValaCCodeBaseModule*) self, _tmp313_, _tmp314_);
					_tmp315_ = prop;
					_tmp316_ = vala_property_get_set_accessor (_tmp315_);
					_tmp317_ = _tmp316_;
					_tmp318_ = vala_get_ccode_real_name ((ValaSymbol*) _tmp317_);
					cname = _tmp318_;
					_tmp320_ = prop;
					_tmp321_ = vala_property_get_is_abstract (_tmp320_);
					_tmp322_ = _tmp321_;
					if (_tmp322_) {
						_tmp319_ = TRUE;
					} else {
						...
						gboolean _tmp325_;
						_tmp323_ = prop;
						_tmp324_ = vala_property_get_is_virtual (_tmp323_);
						_tmp325_ = _tmp324_;
						_tmp319_ = _tmp325_;
					}
					if (_tmp319_) {
						ValaProperty* _tmp326_;
						ValaPropertyAccessor* _tmp327_;
						ValaPropertyAccessor* _tmp328_;
						gchar* _tmp329_;
						_tmp326_ = prop;
						_tmp327_ = vala_property_get_set_accessor (_tmp326_);
						_tmp328_ = _tmp327_;
						_tmp329_ = vala_get_ccode_name ((ValaCodeNode*) _tmp328_);
						_g_free0 (cname);
						cname = _tmp329_;
					}
					_tmp330_ = cname;
					_tmp331_ = vala_ccode_identifier_new (_tmp330_);
					cfunc = (ValaCCodeExpression*) _tmp331_;
					_tmp333_ = prop;
					_tmp334_ = vala_property_get_is_abstract (_tmp333_);
					_tmp335_ = _tmp334_;
					if (_tmp335_) {
						_tmp332_ = TRUE;
					} else {
						...
						gboolean _tmp338_;
						_tmp336_ = prop;
						_tmp337_ = vala_property_get_is_virtual (_tmp336_);
						_tmp338_ = _tmp337_;
						_tmp332_ = _tmp338_;
					}
					if (_tmp332_) {
						...
						_tmp342_ = cfunc;
						_tmp343_ = base_type;
						_tmp344_ = vala_gtype_module_cast_property_accessor_pointer (self, _tmp341_, _tmp342_, _tmp343_);
						_vala_ccode_node_unref0 (cfunc);
						cfunc = _tmp344_;
					}
					...
					_tmp352_ = _tmp351_;
					_tmp353_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp347_, _tmp352_);
					_tmp354_ = _tmp353_;
					_tmp355_ = cfunc;
					vala_ccode_function_add_assignment (_tmp346_, (ValaCCodeExpression*) _tmp354_, _tmp355_);
	...
	}
	{
		...
		gint _tmp360_;
		gint _prop_index = 0;
		_tmp356_ = vala_object_type_symbol_get_properties ((ValaObjectTypeSymbol*) iface);
		_tmp357_ = _vala_iterable_ref0 (_tmp356_);
		_prop_list = _tmp357_;
		_tmp358_ = _prop_list;
		...
		while (TRUE) {
			...
			if (_tmp384_) {
				...
				if (_tmp408_) {
					...
					_tmp427_ = _tmp426_;
					_tmp428_ = cfunc;
					_tmp429_ = vala_gtype_module_cast_property_accessor_pointer (self, _tmp427_, _tmp428_, (ValaObjectTypeSymbol*) iface);
					_vala_ccode_node_unref0 (cfunc);
					cfunc = _tmp429_;
					...
					_tmp432_ = ciface;
					_tmp433_ = prop;
					_tmp434_ = vala_symbol_get_name ((ValaSymbol*) _tmp433_);
					_tmp435_ = _tmp434_;
					_tmp436_ = g_strdup_printf ("get_%s", _tmp435_);
					_tmp437_ = _tmp436_;
					_tmp438_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp432_, _tmp437_);
					_tmp439_ = _tmp438_;
					_tmp440_ = cfunc;
					vala_ccode_function_add_assignment (_tmp431_, (ValaCCodeExpression*) _tmp439_, _tmp440_);
				...
				_tmp443_ = vala_property_get_set_accessor (_tmp442_);
				_tmp444_ = _tmp443_;
				if (_tmp444_ != NULL) {
				...
				if (_tmp441_) {
					...
					gchar* _tmp469_;
					gchar* _tmp470_;
					ValaCCodeMemberAccess* _tmp471_;
					...
					_tmp450_ = _tmp449_;
					_tmp451_ = ((ValaCCodeBaseModule*) self)->cfile;
					vala_ccode_base_module_generate_property_accessor_declaration ((ValaCCodeBaseModule*) self, _tmp450_, _tmp451_);
					...
					cfunc = (ValaCCodeExpression*) _tmp457_;
					_tmp458_ = prop;
					_tmp459_ = vala_property_get_set_accessor (_tmp458_);
					_tmp460_ = _tmp459_;
					_tmp461_ = cfunc;
					_tmp462_ = vala_gtype_module_cast_property_accessor_pointer (self, _tmp460_, _tmp461_, (ValaObjectTypeSymbol*) iface);
					_vala_ccode_node_unref0 (cfunc);
					cfunc = _tmp462_;
					...
					_tmp470_ = _tmp469_;
					_tmp471_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp465_, _tmp470_);
					_tmp472_ = _tmp471_;
					_tmp473_ = cfunc;
					vala_ccode_function_add_assignment (_tmp464_, (ValaCCodeExpression*) _tmp472_, _tmp473_);
	...
	_tmp475_ = iface_init;
	vala_ccode_file_add_function (_tmp474_, _tmp475_);
                                                ...
                                                ValaClass* cl)
{
	...
	if (_tmp25_) {
		...
		vala_ccode_file_add_function_declaration (_tmp26_, _tmp27_);
		{
			...
			while (TRUE) {
				...
				_tmp35_ = _m_list;
				_tmp36_ = vala_list_get (_tmp35_, _m_index);
				m = (ValaMethod*) _tmp36_;
				_tmp38_ = m;
				...
				_tmp41_ = m;
				_tmp42_ = vala_method_get_base_method (_tmp41_);
				_tmp43_ = _tmp42_;
				...
				base_type = _tmp46_;
				_tmp48_ = m;
				_tmp49_ = vala_method_get_is_abstract (_tmp48_);
				_tmp50_ = _tmp49_;
				if (!_tmp50_) {
					_tmp47_ = TRUE;
				} else {
				...
				if (_tmp47_) {
					...
					gboolean _tmp94_;
					_tmp54_ = m;
					_tmp55_ = vala_method_get_base_method (_tmp54_);
					_tmp56_ = _tmp55_;
					_tmp57_ = ((ValaCCodeBaseModule*) self)->cfile;
					vala_ccode_base_module_generate_method_declaration ((ValaCCodeBaseModule*) self, _tmp56_, _tmp57_);
					_tmp58_ = m;
					_tmp59_ = vala_get_ccode_real_name ((ValaSymbol*) _tmp58_);
					_tmp60_ = _tmp59_;
					...
					_tmp67_ = m;
					_tmp68_ = vala_method_get_base_method (_tmp67_);
					_tmp69_ = _tmp68_;
					_tmp70_ = cfunc;
					_tmp71_ = base_type;
					_tmp72_ = vala_gtype_module_cast_method_pointer (self, _tmp69_, _tmp70_, _tmp71_, _tmp63_);
					_vala_ccode_node_unref0 (cfunc);
					cfunc = _tmp72_;
					...
					_tmp83_ = ccast;
					_tmp84_ = m;
					_tmp85_ = vala_method_get_base_method (_tmp84_);
					_tmp86_ = _tmp85_;
					_tmp87_ = vala_get_ccode_vfunc_name (_tmp86_);
					_tmp88_ = _tmp87_;
					_tmp89_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp83_, _tmp88_);
					_tmp90_ = _tmp89_;
					_tmp91_ = cfunc;
					vala_ccode_function_add_assignment (_tmp82_, (ValaCCodeExpression*) _tmp90_, _tmp91_);
					...
					if (_tmp94_) {
						...
						_tmp95_ = m;
						_tmp96_ = vala_get_ccode_finish_real_name (_tmp95_);
						_tmp97_ = _tmp96_;
						_tmp98_ = vala_ccode_identifier_new (_tmp97_);
						_vala_ccode_node_unref0 (cfunc);
						cfunc = (ValaCCodeExpression*) _tmp98_;
						_g_free0 (_tmp97_);
						_tmp99_ = m;
						...
						_tmp102_ = cfunc;
						_tmp103_ = base_type;
						_tmp104_ = vala_gtype_module_cast_method_pointer (self, _tmp101_, _tmp102_, _tmp103_, 2);
						_vala_ccode_node_unref0 (cfunc);
						cfunc = _tmp104_;
						...
						_tmp107_ = ccast;
						_tmp108_ = m;
						_tmp109_ = vala_method_get_base_method (_tmp108_);
						_tmp110_ = _tmp109_;
						_tmp111_ = vala_get_ccode_finish_vfunc_name (_tmp110_);
						_tmp112_ = _tmp111_;
						_tmp113_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp107_, _tmp112_);
						_tmp114_ = _tmp113_;
						_tmp115_ = cfunc;
						vala_ccode_function_add_assignment (_tmp106_, (ValaCCodeExpression*) _tmp114_, _tmp115_);
		...
		}
		{
			...
			gint _tmp120_;
			gint _prop_index = 0;
			_tmp116_ = vala_object_type_symbol_get_properties ((ValaObjectTypeSymbol*) cl);
			...
			while (TRUE) {
				...
				ValaCCodeCastExpression* _tmp143_;
				...
				_tmp123_ = _prop_list;
				_tmp124_ = vala_list_get (_tmp123_, _prop_index);
				prop = (ValaProperty*) _tmp124_;
				_tmp126_ = prop;
				_tmp127_ = vala_property_get_base_property (_tmp126_);
				_tmp128_ = _tmp127_;
				if (_tmp128_ == NULL) {
					_tmp125_ = TRUE;
				} else {
				...
				_tmp129_ = prop;
				_tmp130_ = vala_property_get_base_property (_tmp129_);
				_tmp131_ = _tmp130_;
				_tmp132_ = vala_symbol_get_parent_symbol ((ValaSymbol*) _tmp131_);
				_tmp133_ = _tmp132_;
				_tmp134_ = _vala_code_node_ref0 (_tmp133_);
				base_type = _tmp134_;
				_tmp135_ = vala_ccode_identifier_new ("self");
				_tmp136_ = _tmp135_;
				_tmp137_ = base_type;
				...
				_tmp141_ = _tmp140_;
				_tmp142_ = vala_ccode_cast_expression_new ((ValaCCodeExpression*) _tmp136_, _tmp141_);
				_tmp143_ = _tmp142_;
				_g_free0 (_tmp141_);
				_g_free0 (_tmp139_);
				...
				ccast = _tmp143_;
				_tmp145_ = prop;
				_tmp146_ = vala_property_get_base_property (_tmp145_);
				_tmp147_ = _tmp146_;
				if (!vala_get_ccode_no_accessor_method (_tmp147_)) {
					ValaProperty* _tmp148_;
					ValaProperty* _tmp149_;
					ValaProperty* _tmp150_;
					_tmp148_ = prop;
					_tmp149_ = vala_property_get_base_property (_tmp148_);
					_tmp150_ = _tmp149_;
					_tmp144_ = !vala_get_ccode_concrete_accessor (_tmp150_);
				} else {
					_tmp144_ = FALSE;
				}
				if (_tmp144_) {
					...
					_tmp151_ = prop;
					_tmp152_ = vala_property_get_get_accessor (_tmp151_);
					_tmp153_ = _tmp152_;
					if (_tmp153_ != NULL) {
						...
						_tmp154_ = prop;
						_tmp155_ = vala_property_get_base_property (_tmp154_);
						_tmp156_ = _tmp155_;
						_tmp157_ = vala_property_get_get_accessor (_tmp156_);
						_tmp158_ = _tmp157_;
						_tmp159_ = ((ValaCCodeBaseModule*) self)->cfile;
						vala_ccode_base_module_generate_property_accessor_declaration ((ValaCCodeBaseModule*) self, _tmp158_, _tmp159_);
						_tmp160_ = prop;
						_tmp161_ = vala_property_get_get_accessor (_tmp160_);
						_tmp162_ = _tmp161_;
						_tmp163_ = vala_get_ccode_real_name ((ValaSymbol*) _tmp162_);
						cname = _tmp163_;
						...
						_tmp171_ = _tmp170_;
						_tmp172_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp166_, _tmp171_);
						_tmp173_ = _tmp172_;
						_tmp174_ = cname;
						_tmp175_ = vala_ccode_identifier_new (_tmp174_);
						_tmp176_ = _tmp175_;
						vala_ccode_function_add_assignment (_tmp165_, (ValaCCodeExpression*) _tmp173_, (ValaCCodeExpression*) _tmp176_);
						_vala_ccode_node_unref0 (_tmp176_);
						_vala_ccode_node_unref0 (_tmp173_);
						_g_free0 (_tmp171_);
						_g_free0 (cname);
					...
					if (_tmp179_ != NULL) {
						...
						_tmp180_ = prop;
						_tmp181_ = vala_property_get_base_property (_tmp180_);
						_tmp182_ = _tmp181_;
						_tmp183_ = vala_property_get_set_accessor (_tmp182_);
						_tmp184_ = _tmp183_;
						_tmp185_ = ((ValaCCodeBaseModule*) self)->cfile;
						vala_ccode_base_module_generate_property_accessor_declaration ((ValaCCodeBaseModule*) self, _tmp184_, _tmp185_);
						_tmp186_ = prop;
						_tmp187_ = vala_property_get_set_accessor (_tmp186_);
						_tmp188_ = _tmp187_;
						_tmp189_ = vala_get_ccode_real_name ((ValaSymbol*) _tmp188_);
						cname = _tmp189_;
						...
						_tmp202_ = _tmp201_;
						vala_ccode_function_add_assignment (_tmp191_, (ValaCCodeExpression*) _tmp199_, (ValaCCodeExpression*) _tmp202_);
						_vala_ccode_node_unref0 (_tmp202_);
	...
	_tmp204_ = vala_class_get_is_compact (cl);
	_tmp205_ = _tmp204_;
	if (!_tmp205_) {
		gboolean _tmp206_ = FALSE;
		gboolean _tmp207_;
		gboolean _tmp208_;
		_tmp207_ = vala_class_get_has_private_fields (cl);
		_tmp208_ = _tmp207_;
		if (_tmp208_) {
			_tmp206_ = TRUE;
		} else {
			_tmp206_ = vala_object_type_symbol_has_type_parameters ((ValaObjectTypeSymbol*) cl);
		}
		_tmp203_ = _tmp206_;
	} else {
		_tmp203_ = FALSE;
	...
	if (_tmp203_) {
		...
		_tmp209_ = vala_get_ccode_lower_case_name ((ValaCodeNode*) cl, NULL);
		_tmp210_ = _tmp209_;
		...
		ccall = _tmp216_;
		_tmp217_ = ccall;
		_tmp218_ = vala_ccode_identifier_new ("self");
		_tmp219_ = _tmp218_;
		...
		_tmp222_ = _tmp221_;
		_tmp223_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp222_, "priv");
		_tmp224_ = _tmp223_;
		_tmp225_ = ccall;
		vala_ccode_function_add_assignment (_tmp220_, (ValaCCodeExpression*) _tmp224_, (ValaCCodeExpression*) _tmp225_);
		_vala_ccode_node_unref0 (_tmp224_);
                                           ...
                                           ValaClass* cl)
{
	...
	if (_tmp4_) {
		...
		_tmp15_ = vala_get_ccode_lower_case_prefix ((ValaSymbol*) cl);
		_tmp16_ = _tmp15_;
                                          ...
                                          ValaMethodCall* expr)
{
	...
	if (vala_code_context_require_glib_version (_tmp51_, 2, 54)) {
		...
		_tmp123_ = _tmp122_;
		_tmp124_ = vala_ccode_identifier_new ("NULL");
		_tmp125_ = _tmp124_;
		...
		_tmp135_ = _tmp134_;
		_tmp136_ = vala_ccode_identifier_new ("NULL");
		_tmp137_ = _tmp136_;
