		...
		while (TRUE) {
			...
			if (_tmp204_) {
				...
				if (_tmp221_) {
					...
					_tmp228_ = cl_method;
					_tmp229_ = vala_method_get_base_interface_method (_tmp228_);
					_tmp230_ = _tmp229_;
					if (_tmp230_ != NULL) {
						ValaMethod* _tmp231_;
						ValaMethod* _tmp232_;
						...
						ValaMethod* _tmp237_;
						_tmp235_ = cl_method;
						_tmp236_ = vala_method_get_base_method (_tmp235_);
						_tmp237_ = _tmp236_;
						if (_tmp237_ != NULL) {
							ValaMethod* _tmp238_;
							ValaMethod* _tmp239_;
							...
							ValaMethod* _tmp241_;
							_tmp238_ = cl_method;
							_tmp239_ = vala_method_get_base_method (_tmp238_);
							_tmp240_ = _tmp239_;
                                       ...
                                       gint direction)
{
	...
	while (TRUE) {
		...
		_tmp43_ = cparam_map;
		_tmp44_ = min_pos;
		_tmp45_ = vala_map_get ((ValaMap*) _tmp43_, (gpointer) ((gintptr) _tmp44_));
		cparam = (ValaCCodeParameter*) _tmp45_;
		_tmp46_ = cparam;
		_tmp47_ = vala_ccode_parameter_get_ellipsis (_tmp46_);
		_tmp48_ = _tmp47_;
		if (_tmp48_) {
			const gchar* _tmp49_;
			gchar* _tmp50_;
			...
			_tmp51_ = cast_args;
			_tmp52_ = cparam;
			_tmp53_ = vala_ccode_parameter_get_type_name (_tmp52_);
			_tmp54_ = _tmp53_;
			_tmp55_ = g_strdup_printf ("%s%s", _tmp51_, _tmp54_);
			_g_free0 (cast_args);
			cast_args = _tmp55_;
		}
		_tmp56_ = min_pos;
	...
	cast = _tmp59_;
	_tmp60_ = cast;
	_tmp61_ = vala_ccode_cast_expression_new (cfunc, _tmp60_);
	result = (ValaCCodeExpression*) _tmp61_;
	_g_free0 (cast_args);
	_vala_map_unref0 (cparam_map);
	_vala_ccode_node_unref0 (vdeclarator);
	_g_free0 (cast);
                                           ...
                                           ValaClass* cl)
{
	...
	if (_tmp4_) {
		...
		if (_tmp76_ == NULL) {
			...
			ValaCCodeFunction* _tmp97_;
			_tmp77_ = vala_get_ccode_lower_case_prefix ((ValaSymbol*) cl);
			_tmp78_ = _tmp77_;
			_tmp79_ = g_strdup_printf ("%sfree", _tmp78_);
			_tmp80_ = _tmp79_;
			...
			if (vala_symbol_is_private_symbol ((ValaSymbol*) cl)) {
				ValaCCodeFunction* _tmp83_;
				_tmp83_ = function;
				vala_ccode_node_set_modifiers ((ValaCCodeNode*) _tmp83_, VALA_CCODE_MODIFIERS_STATIC);
			} else {
				...
				gboolean _tmp87_;
				gboolean _tmp88_;
				_tmp85_ = vala_ccode_base_module_get_context ((ValaCCodeBaseModule*) self);
				_tmp86_ = _tmp85_;
				_tmp87_ = vala_code_context_get_hide_internal (_tmp86_);
				_tmp88_ = _tmp87_;
				if (_tmp88_) {
					_tmp84_ = vala_symbol_is_internal_symbol ((ValaSymbol*) cl);
				} else {
					_tmp84_ = FALSE;
				}
				if (_tmp84_) {
					ValaCCodeFunction* _tmp89_;
					_tmp89_ = function;
					vala_ccode_node_set_modifiers ((ValaCCodeNode*) _tmp89_, VALA_CCODE_MODIFIERS_INTERNAL);
				}
			}
			_tmp90_ = function;
			...
			_tmp94_ = _tmp93_;
			_tmp95_ = vala_ccode_parameter_new ("self", _tmp94_);
			_tmp96_ = _tmp95_;
			vala_ccode_function_add_parameter (_tmp90_, _tmp96_);
			_vala_ccode_node_unref0 (_tmp96_);
			_g_free0 (_tmp94_);
			_g_free0 (_tmp92_);
			_tmp97_ = function;
			vala_ccode_base_module_push_function ((ValaCCodeBaseModule*) self, _tmp97_);
			_vala_ccode_node_unref0 (function);
		}
	}
	...
	if (_tmp99_ != NULL) {
		...
		gboolean _tmp112_;
		gboolean _tmp113_;
		_tmp100_ = vala_class_get_destructor (cl);
		_tmp101_ = _tmp100_;
		_tmp102_ = vala_subroutine_get_body ((ValaSubroutine*) _tmp101_);
		_tmp103_ = _tmp102_;
		vala_code_node_emit ((ValaCodeNode*) _tmp103_, (ValaCodeGenerator*) self);
		_tmp104_ = vala_ccode_base_module_get_current_method_inner_error ((ValaCCodeBaseModule*) self);
		_tmp105_ = _tmp104_;
		if (_tmp105_) {
			...
			_tmp109_ = _tmp108_;
			_tmp110_ = vala_ccode_variable_declarator_new_zero ("_inner_error_", (ValaCCodeExpression*) _tmp109_, NULL);
			_tmp111_ = _tmp110_;
			vala_ccode_function_add_declaration (_tmp107_, "GError *", (ValaCCodeDeclarator*) _tmp111_, 0);
                                         ...
                                         ValaClass* cl)
{
	...
	if (!_tmp1_) {
		...
		ValaCCodeBaseModuleEmitContext* _tmp44_;
		ValaCCodeFunction* _tmp45_;
		...
		_tmp44_ = ((ValaCCodeBaseModule*) self)->instance_finalize_context;
		_tmp45_ = _tmp44_->ccode;
		vala_ccode_file_add_function (_tmp43_, _tmp45_);
		_vala_code_node_unref0 (fundamental_class);
	} else {
		ValaClass* _tmp46_;
		ValaClass* _tmp47_;
		...
		if (_tmp47_ == NULL) {
			...
			_tmp48_ = vala_ccode_identifier_new ("g_slice_free");
			_tmp49_ = _tmp48_;
			...
			_tmp68_ = _tmp67_;
			_tmp69_ = ((ValaCCodeBaseModule*) self)->gsource_type;
			if (_tmp68_ == _tmp69_) {
				ValaCCodeFile* _tmp70_;
				ValaCCodeBaseModuleEmitContext* _tmp71_;
				ValaCCodeFunction* _tmp72_;
				_tmp70_ = ((ValaCCodeBaseModule*) self)->cfile;
				_tmp71_ = ((ValaCCodeBaseModule*) self)->instance_finalize_context;
				_tmp72_ = _tmp71_->ccode;
				vala_ccode_file_add_function (_tmp70_, _tmp72_);
			}
		}
	}
}
                                                       ...
                                                       ValaCCodeFile* decl_space)
{
	...
	_g_free0 (_tmp23_);
	_g_free0 (_tmp21_);
	_tmp25_ = vala_get_ccode_upper_case_name ((ValaSymbol*) iface, NULL);
	_tmp26_ = _tmp25_;
	...
	_tmp48_ = _tmp47_;
	_tmp49_ = g_strdup_printf ("%s_GET_INTERFACE(obj)", _tmp48_);
	_tmp50_ = _tmp49_;
	_tmp51_ = macro;
	...
	_g_free0 (_tmp70_);
	{
		...
		while (TRUE) {
			...
			_tmp89_ = _tmp88_;
			_tmp90_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp89_, VALA_TYPE_CLASS) ? ((ValaClass*) _tmp89_) : NULL);
			prereq_cl = _tmp90_;
			_tmp91_ = prerequisite;
			_tmp92_ = vala_data_type_get_data_type (_tmp91_);
			_tmp93_ = _tmp92_;
			_tmp94_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp93_, VALA_TYPE_INTERFACE) ? ((ValaInterface*) _tmp93_) : NULL);
			prereq_iface = _tmp94_;
			_tmp95_ = prereq_cl;
			if (_tmp95_ != NULL) {
				ValaClass* _tmp96_;
				_tmp96_ = prereq_cl;
				vala_ccode_base_module_generate_class_declaration ((ValaCCodeBaseModule*) self, _tmp96_, decl_space);
			} else {
				ValaInterface* _tmp97_;
				_tmp97_ = prereq_iface;
				if (_tmp97_ != NULL) {
					ValaInterface* _tmp98_;
					_tmp98_ = prereq_iface;
					vala_ccode_base_module_generate_interface_declaration ((ValaCCodeBaseModule*) self, _tmp98_, decl_space);
				}
			}
