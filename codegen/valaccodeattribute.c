...
" valid C name if intended");
		...
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp208_, VALA_TYPE_OBJECT_TYPE)) {
			...
			if (!_tmp213_) {
				...
				gchar* _tmp217_;
				_tmp214_ = type;
				_tmp215_ = vala_data_type_get_type_symbol ((ValaDataType*) _tmp214_);
				_tmp216_ = _tmp215_;
				...
				gchar* _tmp221_;
				_tmp218_ = type;
				_tmp219_ = vala_data_type_get_type_symbol ((ValaDataType*) _tmp218_);
				_tmp220_ = _tmp219_;
							...
							if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp265_, VALA_TYPE_METHOD_TYPE)) {
								...
								if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp273_, VALA_TYPE_NULL_TYPE)) {
									...
									if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp281_, VALA_TYPE_POINTER_TYPE)) {
										...
										_tmp287_ = _tmp286_;
										_tmp288_ = vala_data_type_get_type_symbol (_tmp287_);
										_tmp289_ = _tmp288_;
										if (_tmp289_ != NULL) {
										...
										if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp306_, VALA_TYPE_VOID_TYPE)) {
											...
											if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp308_, VALA_TYPE_CLASS_TYPE)) {
												...
												if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp318_, VALA_TYPE_INTERFACE_TYPE)) {
													...
													_tmp323_ = _tmp322_;
													_tmp324_ = vala_get_ccode_type_name ((ValaObjectTypeSymbol*) _tmp323_);
													_tmp325_ = _tmp324_;
													...
													if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp328_, VALA_TYPE_VALUE_TYPE)) {
														...
														type = _tmp330_;
														_tmp331_ = type;
														_tmp332_ = vala_data_type_get_type_symbol ((ValaDataType*) _tmp331_);
														_tmp333_ = _tmp332_;
	...
	if (_tmp0_ != NULL) {
		...
		if (_tmp1_) {
			...
			if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp10_, VALA_TYPE_STRUCT)) {
				...
				_tmp12_ = st;
				if (!vala_get_ccode_has_type_id ((ValaTypeSymbol*) _tmp12_)) {
					...
					ValaStruct* _tmp19_;
					_tmp13_ = st;
					_tmp14_ = vala_struct_get_base_struct (_tmp13_);
					_tmp15_ = _tmp14_;
					base_struct = _tmp15_;
					_tmp16_ = base_struct;
					if (_tmp16_ != NULL) {
						...
						gchar* _tmp18_;
						_tmp17_ = base_struct;
						_tmp18_ = vala_get_ccode_type_id ((ValaCodeNode*) _tmp17_);
						result = _tmp18_;
						return result;
					}
					_tmp19_ = st;
					if (!vala_struct_is_simple_type (_tmp19_)) {
						gchar* _tmp20_;
						_tmp20_ = g_strdup ("G_TYPE_POINTER");
						result = _tmp20_;
						return result;
					}
				} else {
					...
					gchar* _tmp22_;
					_tmp21_ = st;
					_tmp22_ = vala_get_ccode_upper_case_name ((ValaSymbol*) _tmp21_, "TYPE_");
					result = _tmp22_;
					return result;
				}
			} else {
				...
				if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp23_, VALA_TYPE_ENUM)) {
					...
					ValaEnum* _tmp25_;
					_tmp24_ = self->priv->sym;
					en = G_TYPE_CHECK_INSTANCE_CAST (_tmp24_, VALA_TYPE_ENUM, ValaEnum);
					_tmp25_ = en;
					if (vala_get_ccode_has_type_id ((ValaTypeSymbol*) _tmp25_)) {
						ValaEnum* _tmp26_;
						gchar* _tmp27_;
						_tmp26_ = en;
						_tmp27_ = vala_get_ccode_upper_case_name ((ValaSymbol*) _tmp26_, "TYPE_");
						result = _tmp27_;
						return result;
					} else {
						...
						_tmp32_ = g_strdup (_tmp28_);
						result = _tmp32_;
						return result;
					}
				} else {
					gchar* _tmp33_;
					_tmp33_ = g_strdup ("G_TYPE_POINTER");
					result = _tmp33_;
					return result;
				}
			}
		...
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp35_, VALA_TYPE_ARRAY_TYPE)) {
			...
			_tmp37_ = vala_array_type_get_element_type (G_TYPE_CHECK_INSTANCE_CAST (_tmp36_, VALA_TYPE_ARRAY_TYPE, ValaArrayType));
			_tmp38_ = _tmp37_;
			_tmp39_ = vala_data_type_get_type_symbol (_tmp38_);
			_tmp40_ = _tmp39_;
			_tmp41_ = vala_symbol_get_full_name ((ValaSymbol*) _tmp40_);
			_tmp42_ = _tmp41_;
			_tmp34_ = g_strcmp0 (_tmp42_, "string") == 0;
			_g_free0 (_tmp42_);
		} else {
			_tmp34_ = FALSE;
		}
		if (_tmp34_) {
			...
			if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp45_, VALA_TYPE_POINTER_TYPE)) {
				_tmp44_ = TRUE;
			} else {
				ValaCodeNode* _tmp46_;
				_tmp46_ = self->priv->node;
				_tmp44_ = G_TYPE_CHECK_INSTANCE_TYPE (_tmp46_, VALA_TYPE_DELEGATE_TYPE);
			}
			if (_tmp44_) {
				gchar* _tmp47_;
				_tmp47_ = g_strdup ("G_TYPE_POINTER");
				result = _tmp47_;
				return result;
			} else {
				ValaCodeNode* _tmp48_;
				_tmp48_ = self->priv->node;
				if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp48_, VALA_TYPE_ERROR_TYPE)) {
					gchar* _tmp49_;
					_tmp49_ = g_strdup ("G_TYPE_ERROR");
					result = _tmp49_;
					return result;
				} else {
					ValaCodeNode* _tmp50_;
					_tmp50_ = self->priv->node;
					if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp50_, VALA_TYPE_VOID_TYPE)) {
						gchar* _tmp51_;
						_tmp51_ = g_strdup ("G_TYPE_NONE");
						result = _tmp51_;
						return result;
					} else {
						...
						_tmp53_ = _vala_code_node_ref0 (G_TYPE_CHECK_INSTANCE_CAST (_tmp52_, VALA_TYPE_DATA_TYPE, ValaDataType));
						type = _tmp53_;
						_tmp54_ = type;
						...
						if (_tmp56_ != NULL) {
							...
							_tmp59_ = _tmp58_;
							_tmp60_ = vala_get_ccode_type_id ((ValaCodeNode*) _tmp59_);
							result = _tmp60_;
							_vala_code_node_unref0 (type);
							return result;
						}
