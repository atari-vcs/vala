                                                              ...
                                                              ValaArrayCreationExpression* expr)
{
	...
	cexpr = NULL;
	{
		...
		while (TRUE) {
			...
			csize = _tmp51_;
			_tmp52_ = csize;
			vala_ccode_base_module_append_array_length ((ValaCCodeBaseModule*) self, (ValaExpression*) expr, _tmp52_);
			_tmp53_ = first;
			if (_tmp53_) {
	...
	_tmp60_ = vala_array_creation_expression_get_element_type (expr);
	_tmp61_ = _tmp60_;
	...
	if (_tmp63_ != NULL) {
		...
		_tmp64_ = vala_array_creation_expression_get_element_type (expr);
		_tmp65_ = _tmp64_;
		_tmp66_ = vala_data_type_get_data_type (_tmp65_);
		_tmp67_ = _tmp66_;
		_tmp59_ = vala_typesymbol_is_reference_type (_tmp67_);
	} else {
		_tmp59_ = FALSE;
	}
	if (_tmp59_) {
		...
		_tmp70_ = _tmp69_;
		_tmp71_ = vala_ccode_binary_expression_new (VALA_CCODE_BINARY_OPERATOR_PLUS, _tmp68_, (ValaCCodeExpression*) _tmp70_);
		_vala_ccode_node_unref0 (cexpr);
		cexpr = (ValaCCodeExpression*) _tmp71_;
		_vala_ccode_node_unref0 (_tmp70_);
	}
	_tmp72_ = gnew;
	_tmp73_ = cexpr;
	vala_ccode_function_call_add_argument (_tmp72_, _tmp73_);
	_tmp74_ = vala_ccode_base_module_get_context ((ValaCCodeBaseModule*) self);
	_tmp75_ = _tmp74_;
	_tmp76_ = vala_code_context_get_profile (_tmp75_);
	_tmp77_ = _tmp76_;
	if (_tmp77_ == VALA_PROFILE_POSIX) {
		...
		_tmp78_ = vala_ccode_identifier_new ("sizeof");
		_tmp79_ = _tmp78_;
		...
		csizeof = _tmp81_;
		_tmp82_ = csizeof;
		_tmp83_ = vala_array_creation_expression_get_element_type (expr);
		_tmp84_ = _tmp83_;
		_tmp85_ = vala_get_ccode_name ((ValaCodeNode*) _tmp84_);
		_tmp86_ = _tmp85_;
		_tmp87_ = vala_ccode_identifier_new (_tmp86_);
		_tmp88_ = _tmp87_;
		vala_ccode_function_call_add_argument (_tmp82_, (ValaCCodeExpression*) _tmp88_);
	...
	_tmp91_ = vala_expression_get_value_type ((ValaExpression*) expr);
	_tmp92_ = _tmp91_;
	_tmp93_ = vala_ccode_base_module_get_temp_variable ((ValaCCodeBaseModule*) self, _tmp92_, TRUE, (ValaCodeNode*) expr, FALSE);
	temp_var = _tmp93_;
	_tmp94_ = temp_var;
	...
	i = 0;
	_tmp98_ = temp_var;
	vala_ccode_base_module_emit_temp_var ((ValaCCodeBaseModule*) self, _tmp98_, FALSE);
	...
	_tmp103_ = vala_array_creation_expression_get_initializer_list (expr);
	_tmp104_ = _tmp103_;
	if (_tmp104_ != NULL) {
		...
		gint _tmp109_;
		_tmp105_ = name_cnode;
		_tmp106_ = vala_array_creation_expression_get_initializer_list (expr);
		_tmp107_ = _tmp106_;
		_tmp108_ = vala_array_creation_expression_get_rank (expr);
		_tmp109_ = _tmp108_;
		vala_ccode_array_module_append_initializer_list (self, _tmp105_, _tmp107_, _tmp109_, &i);
	}
	_tmp110_ = name_cnode;
	vala_ccode_base_module_set_cvalue ((ValaCCodeBaseModule*) self, (ValaExpression*) expr, _tmp110_);
	_vala_ccode_node_unref0 (name_cnode);
	_vala_code_node_unref0 (temp_var);
	_vala_ccode_node_unref0 (cexpr);
	_vala_ccode_node_unref0 (gnew);
