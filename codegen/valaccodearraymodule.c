                                                    ...
                                                    ValaArrayType* array_type)
{
	...
	if (vala_ccode_base_module_requires_copy (_tmp40_)) {
		...
		_tmp168_ = _tmp167_;
		_tmp169_ = vala_ccode_identifier_new ("NULL");
		_tmp170_ = _tmp169_;
		...
		_tmp257_ = _tmp256_;
		_tmp258_ = vala_ccode_identifier_new ("NULL");
		_tmp259_ = _tmp258_;
                                                  ...
                                                  ValaMethod* m)
{
	...
	if (!G_TYPE_CHECK_INSTANCE_TYPE (m, VALA_TYPE_CREATION_METHOD)) {
		...
		_tmp125_ = _tmp124_;
		vala_ccode_function_add_declaration (_tmp118_, "va_list", (ValaCCodeDeclarator*) _tmp125_, 0);
		_vala_ccode_node_unref0 (_tmp125_);
		_g_free0 (_tmp123_);
		_g_free0 (_tmp121_);
		_tmp126_ = vala_ccode_identifier_new ("va_start");
		_tmp127_ = _tmp126_;
		...
		_tmp145_ = _tmp144_;
		vala_ccode_function_call_add_argument (_tmp138_, (ValaCCodeExpression*) _tmp145_);
		_vala_ccode_node_unref0 (_tmp145_);
		_g_free0 (_tmp143_);
		_g_free0 (_tmp141_);
		_tmp146_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
	...
	_tmp150_ = _tmp149_;
	_tmp151_ = element;
	_tmp152_ = vala_ccode_base_module_get_local_cexpression ((ValaCCodeBaseModule*) self, _tmp151_);
	_tmp153_ = _tmp152_;
	_tmp154_ = local;
	...
	_tmp160_ = _tmp159_;
	vala_ccode_function_add_assignment (_tmp150_, _tmp153_, (ValaCCodeExpression*) _tmp160_);
	...
	_tmp162_ = _tmp161_;
	_tmp163_ = element;
	_tmp164_ = vala_ccode_base_module_get_local_cexpression ((ValaCCodeBaseModule*) self, _tmp163_);
	_tmp165_ = _tmp164_;
	...
	_tmp170_ = vala_ccode_identifier_new ("va_arg");
	_tmp171_ = _tmp170_;
	...
	_tmp180_ = _tmp179_;
	vala_ccode_function_call_add_argument (vaarg, (ValaCCodeExpression*) _tmp180_);
	...
	_tmp187_ = _tmp186_;
	vala_ccode_function_call_add_argument (vaarg, (ValaCCodeExpression*) _tmp187_);
	_vala_ccode_node_unref0 (_tmp187_);
	_g_free0 (_tmp185_);
	_tmp188_ = array_type;
	_tmp189_ = vala_ccode_array_module_generate_array_add_wrapper (self, _tmp188_);
	_tmp190_ = _tmp189_;
	...
	_tmp210_ = element;
	_tmp211_ = vala_ccode_base_module_get_local_cexpression ((ValaCCodeBaseModule*) self, _tmp210_);
	_tmp212_ = _tmp211_;
	vala_ccode_function_call_add_argument (ccall, _tmp212_);
	_vala_ccode_node_unref0 (_tmp212_);
	_tmp213_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
	_tmp214_ = _tmp213_;
	vala_ccode_function_add_expression (_tmp214_, (ValaCCodeExpression*) ccall);
	_tmp215_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
	_tmp216_ = _tmp215_;
	_tmp217_ = element;
	_tmp218_ = vala_ccode_base_module_get_local_cexpression ((ValaCCodeBaseModule*) self, _tmp217_);
	_tmp219_ = _tmp218_;
	vala_ccode_function_add_assignment (_tmp216_, _tmp219_, (ValaCCodeExpression*) vaarg);
	...
	_tmp222_ = vala_ccode_identifier_new ("va_end");
	_tmp223_ = _tmp222_;
	...
	_tmp232_ = _tmp231_;
	vala_ccode_function_call_add_argument (vaend, (ValaCCodeExpression*) _tmp232_);
	_vala_ccode_node_unref0 (_tmp232_);
	_g_free0 (_tmp230_);
	_g_free0 (_tmp228_);
	_tmp233_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
	_tmp234_ = _tmp233_;
	vala_ccode_function_add_expression (_tmp234_, (ValaCCodeExpression*) vaend);
