                                             ...
                                             ValaCCodeExpression* variant_expr)
{
	...
	_tmp50_ = _tmp49_;
	if (vala_typesymbol_is_subtype_of (_tmp47_, _tmp50_)) {
		ValaCCodeFunctionCall* _tmp51_;
		ValaCCodeIdentifier* _tmp52_;
	...
	_tmp77_ = vala_data_type_get_type_symbol (_tmp76_);
	_tmp78_ = _tmp77_;
	if (vala_typesymbol_is_subtype_of (_tmp75_, _tmp78_)) {
		...
		if (_tmp84_ == G_TYPE_CHECK_INSTANCE_CAST (_tmp85_, VALA_TYPE_TYPESYMBOL, ValaTypeSymbol)) {
			...
			_tmp95_ = _tmp94_;
			_tmp96_ = g_strcmp0 (_tmp95_, "GLib.HashTable") == 0;
			_g_free0 (_tmp95_);
			if (_tmp96_) {
				...
				_tmp97_ = hash_table_new;
				_tmp98_ = vala_ccode_identifier_new ("g_hash_table_unref");
				_tmp99_ = _tmp98_;
				_tmp100_ = vala_ccode_cast_expression_new ((ValaCCodeExpression*) _tmp99_, "GDestroyNotify");
				_tmp101_ = _tmp100_;
				...
				_tmp102_ = hash_table_new;
				_tmp103_ = vala_ccode_identifier_new ("NULL");
				_tmp104_ = _tmp103_;
	...
	_tmp107_ = _tmp106_;
	_tmp108_ = ((ValaCCodeBaseModule*) self)->string_type;
	_tmp109_ = vala_data_type_get_type_symbol (_tmp108_);
	_tmp110_ = _tmp109_;
	if (vala_typesymbol_is_subtype_of (_tmp107_, _tmp110_)) {
		ValaCCodeFunctionCall* _tmp111_;
		ValaCCodeIdentifier* _tmp112_;
		ValaCCodeIdentifier* _tmp113_;
		_tmp111_ = hash_table_new;
		_tmp112_ = vala_ccode_identifier_new ("g_free");
		_tmp113_ = _tmp112_;
		...
		_tmp116_ = _tmp115_;
		_tmp117_ = ((ValaCCodeBaseModule*) self)->gvariant_type;
		if (_tmp116_ == G_TYPE_CHECK_INSTANCE_CAST (_tmp117_, VALA_TYPE_TYPESYMBOL, ValaTypeSymbol)) {
			...
			_tmp119_ = vala_ccode_identifier_new ("g_variant_unref");
			_tmp120_ = _tmp119_;
			_tmp121_ = vala_ccode_cast_expression_new ((ValaCCodeExpression*) _tmp120_, "GDestroyNotify");
			_tmp122_ = _tmp121_;
			vala_ccode_function_call_add_argument (_tmp118_, (ValaCCodeExpression*) _tmp122_);
			_vala_ccode_node_unref0 (_tmp122_);
			_vala_ccode_node_unref0 (_tmp120_);
		} else {
			...
			_tmp127_ = _tmp126_;
			_tmp128_ = g_strcmp0 (_tmp127_, "GLib.HashTable") == 0;
			_g_free0 (_tmp127_);
			if (_tmp128_) {
				ValaCCodeFunctionCall* _tmp129_;
				...
				_tmp129_ = hash_table_new;
				_tmp130_ = vala_ccode_identifier_new ("g_hash_table_unref");
				_tmp131_ = _tmp130_;
				_tmp132_ = vala_ccode_cast_expression_new ((ValaCCodeExpression*) _tmp131_, "GDestroyNotify");
				_tmp133_ = _tmp132_;
				vala_ccode_function_call_add_argument (_tmp129_, (ValaCCodeExpression*) _tmp133_);
				_vala_ccode_node_unref0 (_tmp133_);
				...
				ValaCCodeIdentifier* _tmp136_;
				_tmp134_ = hash_table_new;
				_tmp135_ = vala_ccode_identifier_new ("NULL");
				_tmp136_ = _tmp135_;
	...
	_tmp141_ = _tmp140_;
	_tmp142_ = hash_table_new;
	vala_ccode_function_add_assignment (_tmp138_, (ValaCCodeExpression*) _tmp141_, (ValaCCodeExpression*) _tmp142_);
	_vala_ccode_node_unref0 (_tmp141_);
	_tmp143_ = vala_ccode_identifier_new ("g_variant_iter_init");
	_tmp144_ = _tmp143_;
	...
	_tmp152_ = _tmp151_;
	vala_ccode_function_call_add_argument (_tmp147_, (ValaCCodeExpression*) _tmp152_);
	_vala_ccode_node_unref0 (_tmp152_);
	_vala_ccode_node_unref0 (_tmp150_);
	_tmp153_ = iter_call;
	vala_ccode_function_call_add_argument (_tmp153_, variant_expr);
	...
	_tmp157_ = vala_ccode_identifier_new ("g_variant_iter_loop");
	_tmp158_ = _tmp157_;
	...
	_tmp166_ = iter_call;
	_tmp167_ = vala_ccode_constant_new ("\"{?*}\"");
	_tmp168_ = _tmp167_;
	...
	_tmp178_ = _tmp177_;
	_tmp179_ = vala_ccode_unary_expression_new (VALA_CCODE_UNARY_OPERATOR_ADDRESS_OF, (ValaCCodeExpression*) _tmp178_);
	_tmp180_ = _tmp179_;
	vala_ccode_function_call_add_argument (_tmp175_, (ValaCCodeExpression*) _tmp180_);
	...
	_tmp182_ = _tmp181_;
	_tmp183_ = iter_call;
	vala_ccode_function_open_while (_tmp182_, (ValaCCodeExpression*) _tmp183_);
	_tmp184_ = key_type;
	_tmp185_ = key_name;
	_tmp186_ = vala_ccode_identifier_new (_tmp185_);
	_tmp187_ = _tmp186_;
	_tmp188_ = vala_ccode_base_module_deserialize_expression ((ValaCCodeBaseModule*) self, _tmp184_, (ValaCCodeExpression*) _tmp187_, NULL, NULL, NULL);
	_tmp189_ = _tmp188_;
	...
	_tmp193_ = _tmp192_;
	_tmp194_ = vala_ccode_base_module_deserialize_expression ((ValaCCodeBaseModule*) self, _tmp190_, (ValaCCodeExpression*) _tmp193_, NULL, NULL, NULL);
	_tmp195_ = _tmp194_;
	...
	_tmp199_ = vala_ccode_identifier_new ("g_hash_table_insert");
	_tmp200_ = _tmp199_;
	_tmp201_ = vala_ccode_function_call_new ((ValaCCodeExpression*) _tmp200_);
	_tmp202_ = _tmp201_;
	_vala_ccode_node_unref0 (_tmp200_);
	hash_table_insert = _tmp202_;
	_tmp203_ = hash_table_insert;
	_tmp204_ = temp_name;
	_tmp205_ = vala_ccode_identifier_new (_tmp204_);
	_tmp206_ = _tmp205_;
	vala_ccode_function_call_add_argument (_tmp203_, (ValaCCodeExpression*) _tmp206_);
	_vala_ccode_node_unref0 (_tmp206_);
	_tmp207_ = hash_table_insert;
	_tmp208_ = key_expr;
	_tmp209_ = key_type;
	_tmp210_ = vala_ccode_base_module_convert_to_generic_pointer ((ValaCCodeBaseModule*) self, _tmp208_, _tmp209_);
	_tmp211_ = _tmp210_;
	vala_ccode_function_call_add_argument (_tmp207_, _tmp211_);
	_vala_ccode_node_unref0 (_tmp211_);
	_tmp212_ = hash_table_insert;
	_tmp213_ = value_expr;
	_tmp214_ = value_type;
	_tmp215_ = vala_ccode_base_module_convert_to_generic_pointer ((ValaCCodeBaseModule*) self, _tmp213_, _tmp214_);
	_tmp216_ = _tmp215_;
	vala_ccode_function_call_add_argument (_tmp212_, _tmp216_);
	...
	result = (ValaCCodeExpression*) _tmp223_;
                                           ...
                                           ValaCCodeExpression* hash_table_expr)
{
	...
	vala_ccode_function_call_add_argument (_tmp51_, hash_table_expr);
	_tmp52_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
	_tmp53_ = _tmp52_;
	_tmp54_ = iter_init_call;
	vala_ccode_function_add_expression (_tmp53_, (ValaCCodeExpression*) _tmp54_);
	_tmp55_ = vala_ccode_identifier_new ("G_VARIANT_TYPE");
	_tmp56_ = _tmp55_;
	_tmp57_ = vala_ccode_function_call_new ((ValaCCodeExpression*) _tmp56_);
	_tmp58_ = _tmp57_;
	_vala_ccode_node_unref0 (_tmp56_);
	gvariant_type = _tmp58_;
	_tmp59_ = gvariant_type;
	_tmp60_ = vala_data_type_get_type_signature ((ValaDataType*) type, NULL);
	_tmp61_ = _tmp60_;
	...
	_g_free0 (_tmp63_);
	_g_free0 (_tmp61_);
	_tmp66_ = vala_ccode_identifier_new ("g_variant_builder_init");
	_tmp67_ = _tmp66_;
	...
	_tmp81_ = vala_ccode_identifier_new ("g_hash_table_iter_next");
	_tmp82_ = _tmp81_;
	_tmp83_ = vala_ccode_function_call_new ((ValaCCodeExpression*) _tmp82_);
	_tmp84_ = _tmp83_;
	_vala_ccode_node_unref0 (_tmp82_);
	iter_next_call = _tmp84_;
	_tmp85_ = iter_next_call;
	_tmp86_ = tableiter_name;
	...
	_tmp103_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
	_tmp104_ = _tmp103_;
	_tmp105_ = iter_next_call;
	vala_ccode_function_open_while (_tmp104_, (ValaCCodeExpression*) _tmp105_);
	_tmp106_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
	_tmp107_ = _tmp106_;
	_tmp108_ = key_type;
	_tmp109_ = vala_get_ccode_name ((ValaCodeNode*) _tmp108_);
	_tmp110_ = _tmp109_;
	_tmp111_ = vala_ccode_variable_declarator_new ("_key", NULL, NULL);
	_tmp112_ = _tmp111_;
	vala_ccode_function_add_declaration (_tmp107_, _tmp110_, (ValaCCodeDeclarator*) _tmp112_, 0);
	_vala_ccode_node_unref0 (_tmp112_);
	_g_free0 (_tmp110_);
	...
	_tmp117_ = _tmp116_;
	_tmp118_ = vala_ccode_variable_declarator_new ("_value", NULL, NULL);
	_tmp119_ = _tmp118_;
	...
	_tmp121_ = _tmp120_;
	_tmp122_ = vala_ccode_identifier_new ("_key");
	_tmp123_ = _tmp122_;
	_tmp124_ = key_name;
	_tmp125_ = vala_ccode_identifier_new (_tmp124_);
	_tmp126_ = _tmp125_;
	_tmp127_ = key_type;
	_tmp128_ = vala_ccode_base_module_convert_from_generic_pointer ((ValaCCodeBaseModule*) self, (ValaCCodeExpression*) _tmp126_, _tmp127_);
	_tmp129_ = _tmp128_;
	vala_ccode_function_add_assignment (_tmp121_, (ValaCCodeExpression*) _tmp123_, _tmp129_);
	_vala_ccode_node_unref0 (_tmp129_);
	_vala_ccode_node_unref0 (_tmp126_);
	_vala_ccode_node_unref0 (_tmp123_);
	_tmp130_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
	_tmp131_ = _tmp130_;
	_tmp132_ = vala_ccode_identifier_new ("_value");
	_tmp133_ = _tmp132_;
	_tmp134_ = value_name;
	_tmp135_ = vala_ccode_identifier_new (_tmp134_);
	_tmp136_ = _tmp135_;
	_tmp137_ = value_type;
	_tmp138_ = vala_ccode_base_module_convert_from_generic_pointer ((ValaCCodeBaseModule*) self, (ValaCCodeExpression*) _tmp136_, _tmp137_);
	_tmp139_ = _tmp138_;
	vala_ccode_function_add_assignment (_tmp131_, (ValaCCodeExpression*) _tmp133_, _tmp139_);
	_vala_ccode_node_unref0 (_tmp139_);
	_vala_ccode_node_unref0 (_tmp136_);
	_vala_ccode_node_unref0 (_tmp133_);
	_tmp140_ = key_type;
	_tmp141_ = vala_ccode_identifier_new ("_key");
	_tmp142_ = _tmp141_;
	_tmp143_ = vala_ccode_base_module_serialize_expression ((ValaCCodeBaseModule*) self, _tmp140_, (ValaCCodeExpression*) _tmp142_);
	_tmp144_ = _tmp143_;
	_vala_ccode_node_unref0 (_tmp142_);
	serialized_key = _tmp144_;
	_tmp145_ = value_type;
	_tmp146_ = vala_ccode_identifier_new ("_value");
	_tmp147_ = _tmp146_;
	_tmp148_ = vala_ccode_base_module_serialize_expression ((ValaCCodeBaseModule*) self, _tmp145_, (ValaCCodeExpression*) _tmp147_);
	_tmp149_ = _tmp148_;
	_vala_ccode_node_unref0 (_tmp147_);
	serialized_value = _tmp149_;
	_tmp151_ = serialized_key;
	if (_tmp151_ == NULL) {
		_tmp150_ = TRUE;
	} else {
		ValaCCodeExpression* _tmp152_;
		_tmp152_ = serialized_value;
	...
	_tmp153_ = vala_ccode_identifier_new ("g_variant_builder_add");
	_tmp154_ = _tmp153_;
	_tmp155_ = vala_ccode_function_call_new ((ValaCCodeExpression*) _tmp154_);
	_vala_ccode_node_unref0 (iter_call);
	iter_call = _tmp155_;
	...
	_tmp162_ = iter_call;
	_tmp163_ = vala_ccode_constant_new ("\"{?*}\"");
	_tmp164_ = _tmp163_;
	vala_ccode_function_call_add_argument (_tmp162_, (ValaCCodeExpression*) _tmp164_);
	_vala_ccode_node_unref0 (_tmp164_);
	_tmp165_ = iter_call;
	_tmp166_ = serialized_key;
	vala_ccode_function_call_add_argument (_tmp165_, _tmp166_);
	_tmp167_ = iter_call;
	_tmp168_ = serialized_value;
	...
	_tmp174_ = vala_ccode_identifier_new ("g_variant_builder_end");
	_tmp175_ = _tmp174_;
