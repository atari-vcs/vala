                                                  ...
                                                  ValaMethodCall* expr)
{
	...
	gchar* _tmp443_;
	gchar* _tmp444_;
	ValaCCodeCastExpression* _tmp445_;
	ValaCCodeCastExpression* _tmp446_;
	...
	if (_tmp135_) {
		...
		if (_tmp138_) {
			...
			_tmp181_ = ccall;
			_tmp182_ = source_ref;
			_tmp183_ = vala_ccode_cast_expression_new (_tmp182_, "GAsyncInitable *");
			_tmp184_ = _tmp183_;
			vala_ccode_function_call_add_argument (_tmp181_, (ValaCCodeExpression*) _tmp184_);
			_vala_ccode_node_unref0 (_tmp184_);
			_tmp185_ = ccall;
			_tmp186_ = res;
			_tmp187_ = vala_ccode_base_module_get_cvalue ((ValaCCodeBaseModule*) self, _tmp186_);
			_tmp188_ = _tmp187_;
			vala_ccode_function_call_add_argument (_tmp185_, _tmp188_);
			_vala_ccode_node_unref0 (_tmp188_);
			_tmp189_ = ccall;
			_tmp190_ = vala_ccode_base_module_get_variable_cexpression ((ValaCCodeBaseModule*) self, "_inner_error_");
			_tmp191_ = _tmp190_;
			_tmp192_ = vala_ccode_unary_expression_new (VALA_CCODE_UNARY_OPERATOR_ADDRESS_OF, _tmp191_);
			_tmp193_ = _tmp192_;
			...
			_tmp195_ = _tmp194_;
			_tmp196_ = vala_expression_get_value_type ((ValaExpression*) expr);
			_tmp197_ = _tmp196_;
			_tmp198_ = vala_data_type_get_value_owned (_tmp197_);
			_tmp199_ = _tmp198_;
			_tmp200_ = vala_ccode_base_module_get_temp_variable ((ValaCCodeBaseModule*) self, _tmp195_, _tmp199_, NULL, FALSE);
			temp_var = _tmp200_;
			_tmp201_ = temp_var;
			...
			temp_ref = _tmp204_;
			_tmp205_ = temp_var;
			vala_ccode_base_module_emit_temp_var ((ValaCCodeBaseModule*) self, _tmp205_, FALSE);
			_tmp206_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
			_tmp207_ = _tmp206_;
			_tmp208_ = temp_ref;
			_tmp209_ = ccall;
			_tmp210_ = vala_expression_get_value_type ((ValaExpression*) expr);
			_tmp211_ = _tmp210_;
			...
			_tmp215_ = _tmp214_;
			vala_ccode_function_add_assignment (_tmp207_, _tmp208_, (ValaCCodeExpression*) _tmp215_);
			_vala_ccode_node_unref0 (_tmp215_);
			_g_free0 (_tmp213_);
			_tmp216_ = vala_ccode_identifier_new ("g_object_unref");
			_tmp217_ = _tmp216_;
			_tmp218_ = vala_ccode_function_call_new ((ValaCCodeExpression*) _tmp217_);
			_tmp219_ = _tmp218_;
			_vala_ccode_node_unref0 (_tmp217_);
			unref_proxy = _tmp219_;
			_tmp220_ = unref_proxy;
			_tmp221_ = source_ref;
			...
			_tmp223_ = _tmp222_;
			_tmp224_ = unref_proxy;
			vala_ccode_function_add_expression (_tmp223_, (ValaCCodeExpression*) _tmp224_);
			_tmp225_ = temp_ref;
			vala_ccode_base_module_set_cvalue ((ValaCCodeBaseModule*) self, (ValaExpression*) expr, _tmp225_);
	...
	if (_tmp227_) {
		...
		gboolean _tmp228_;
		_tmp228_ = bus_get_proxy_sync;
		_tmp226_ = _tmp228_;
	}
	if (_tmp226_) {
		base_arg_index = 1;
	}
	_tmp229_ = vala_method_call_get_argument_list (expr);
	args = _tmp229_;
	_tmp230_ = args;
	_tmp231_ = base_arg_index;
	_tmp232_ = vala_list_get (_tmp230_, _tmp231_ + 0);
	name = (ValaExpression*) _tmp232_;
	_tmp233_ = args;
	_tmp234_ = base_arg_index;
	_tmp235_ = vala_list_get (_tmp233_, _tmp234_ + 1);
	object_path = (ValaExpression*) _tmp235_;
	_tmp236_ = args;
	_tmp237_ = base_arg_index;
	_tmp238_ = vala_list_get (_tmp236_, _tmp237_ + 2);
	flags = (ValaExpression*) _tmp238_;
	_tmp239_ = args;
	_tmp240_ = base_arg_index;
	_tmp241_ = vala_list_get (_tmp239_, _tmp240_ + 3);
	cancellable = (ValaExpression*) _tmp241_;
	vala_ccode_base_module_set_current_method_inner_error ((ValaCCodeBaseModule*) self, TRUE);
	_tmp243_ = bus_get_proxy_async;
	if (_tmp243_) {
		_tmp242_ = TRUE;
	} else {
		gboolean _tmp244_;
	...
	if (_tmp242_) {
		...
		_tmp245_ = vala_ccode_identifier_new ("g_async_initable_new_async");
		_tmp246_ = _tmp245_;
		...
		_tmp248_ = vala_ccode_identifier_new ("g_initable_new");
		_tmp249_ = _tmp248_;
	...
	_tmp254_ = bus_get_proxy_async;
	if (_tmp254_) {
		_tmp253_ = TRUE;
	} else {
		gboolean _tmp255_;
		_tmp255_ = conn_get_proxy_async;
		_tmp253_ = _tmp255_;
	}
	if (_tmp253_) {
		...
		_tmp256_ = ccall;
		_tmp257_ = vala_ccode_constant_new ("0");
		_tmp258_ = _tmp257_;
	...
	_tmp261_ = vala_ccode_base_module_get_cvalue ((ValaCCodeBaseModule*) self, _tmp260_);
	_tmp262_ = _tmp261_;
	vala_ccode_function_call_add_argument (_tmp259_, _tmp262_);
	_vala_ccode_node_unref0 (_tmp262_);
	_tmp264_ = bus_get_proxy_async;
	if (_tmp264_) {
		_tmp263_ = TRUE;
	} else {
		gboolean _tmp265_;
		_tmp265_ = conn_get_proxy_async;
		_tmp263_ = _tmp265_;
	}
	if (_tmp263_) {
		gboolean _tmp266_;
		gboolean _tmp267_;
		_tmp266_ = vala_method_call_get_is_yield_expression (expr);
		_tmp267_ = _tmp266_;
		if (_tmp267_) {
			...
			_tmp268_ = ccall;
			_tmp269_ = vala_ccode_base_module_get_current_method ((ValaCCodeBaseModule*) self);
			_tmp270_ = _tmp269_;
			_tmp271_ = vala_ccode_base_module_generate_ready_function ((ValaCCodeBaseModule*) self, _tmp270_);
			_tmp272_ = _tmp271_;
			_tmp273_ = vala_ccode_identifier_new (_tmp272_);
			_tmp274_ = _tmp273_;
			vala_ccode_function_call_add_argument (_tmp268_, (ValaCCodeExpression*) _tmp274_);
			_vala_ccode_node_unref0 (_tmp274_);
			_g_free0 (_tmp272_);
			_tmp275_ = ccall;
			_tmp276_ = vala_ccode_identifier_new ("_data_");
			_tmp277_ = _tmp276_;
			...
			_tmp278_ = args;
			_tmp279_ = base_arg_index;
			_tmp280_ = vala_list_get (_tmp278_, _tmp279_ + 4);
			callback = (ValaExpression*) _tmp280_;
			_tmp281_ = ccall;
			_tmp282_ = callback;
			_tmp283_ = vala_ccode_base_module_get_cvalue ((ValaCCodeBaseModule*) self, _tmp282_);
			_tmp284_ = _tmp283_;
			vala_ccode_function_call_add_argument (_tmp281_, _tmp284_);
			_vala_ccode_node_unref0 (_tmp284_);
			_tmp285_ = ccall;
			_tmp286_ = callback;
			_tmp287_ = vala_ccode_base_module_get_delegate_target ((ValaCCodeBaseModule*) self, _tmp286_);
			_tmp288_ = _tmp287_;
		...
		_tmp289_ = ccall;
		_tmp290_ = vala_ccode_base_module_get_variable_cexpression ((ValaCCodeBaseModule*) self, "_inner_error_");
		_tmp291_ = _tmp290_;
		_tmp292_ = vala_ccode_unary_expression_new (VALA_CCODE_UNARY_OPERATOR_ADDRESS_OF, _tmp291_);
		_tmp293_ = _tmp292_;
		vala_ccode_function_call_add_argument (_tmp289_, (ValaCCodeExpression*) _tmp293_);
		_vala_ccode_node_unref0 (_tmp293_);
		_vala_ccode_node_unref0 (_tmp291_);
	}
	_tmp294_ = ccall;
	_tmp295_ = vala_ccode_constant_new ("\"g-flags\"");
	_tmp296_ = _tmp295_;
	vala_ccode_function_call_add_argument (_tmp294_, (ValaCCodeExpression*) _tmp296_);
	_vala_ccode_node_unref0 (_tmp296_);
	_tmp297_ = ccall;
	_tmp298_ = flags;
	_tmp299_ = vala_ccode_base_module_get_cvalue ((ValaCCodeBaseModule*) self, _tmp298_);
	_tmp300_ = _tmp299_;
	vala_ccode_function_call_add_argument (_tmp297_, _tmp300_);
	_vala_ccode_node_unref0 (_tmp300_);
	_tmp301_ = ccall;
	_tmp302_ = vala_ccode_constant_new ("\"g-name\"");
	_tmp303_ = _tmp302_;
	vala_ccode_function_call_add_argument (_tmp301_, (ValaCCodeExpression*) _tmp303_);
	_vala_ccode_node_unref0 (_tmp303_);
	_tmp304_ = ccall;
	_tmp305_ = name;
	_tmp306_ = vala_ccode_base_module_get_cvalue ((ValaCCodeBaseModule*) self, _tmp305_);
	_tmp307_ = _tmp306_;
	vala_ccode_function_call_add_argument (_tmp304_, _tmp307_);
	_vala_ccode_node_unref0 (_tmp307_);
	_tmp309_ = bus_get_proxy_async;
	if (_tmp309_) {
		_tmp308_ = TRUE;
	} else {
		gboolean _tmp310_;
		_tmp310_ = bus_get_proxy_sync;
		_tmp308_ = _tmp310_;
	}
	if (_tmp308_) {
		...
		_tmp311_ = args;
		_tmp312_ = vala_list_get (_tmp311_, 0);
		bus_type = (ValaExpression*) _tmp312_;
		_tmp313_ = ccall;
		_tmp314_ = vala_ccode_constant_new ("\"g-bus-type\"");
		_tmp315_ = _tmp314_;
		vala_ccode_function_call_add_argument (_tmp313_, (ValaCCodeExpression*) _tmp315_);
		_vala_ccode_node_unref0 (_tmp315_);
		_tmp316_ = ccall;
		_tmp317_ = bus_type;
		_tmp318_ = vala_ccode_base_module_get_cvalue ((ValaCCodeBaseModule*) self, _tmp317_);
		_tmp319_ = _tmp318_;
		vala_ccode_function_call_add_argument (_tmp316_, _tmp319_);
	...
	if (_tmp363_ != NULL) {
		...
		_tmp364_ = ccall;
		_tmp365_ = vala_ccode_constant_new ("\"g-interface-info\"");
		_tmp366_ = _tmp365_;
		vala_ccode_function_call_add_argument (_tmp364_, (ValaCCodeExpression*) _tmp366_);
		_vala_ccode_node_unref0 (_tmp366_);
		_tmp367_ = ccall;
		_tmp368_ = dbus_iface_info;
		vala_ccode_function_call_add_argument (_tmp367_, _tmp368_);
	}
	_tmp369_ = ccall;
	...
	_tmp373_ = bus_get_proxy_async;
	if (_tmp373_) {
		_tmp372_ = TRUE;
	} else {
		gboolean _tmp374_;
		_tmp374_ = conn_get_proxy_async;
		_tmp372_ = _tmp374_;
	}
	if (_tmp372_) {
		gboolean _tmp375_;
		gboolean _tmp376_;
		_tmp375_ = vala_method_call_get_is_yield_expression (expr);
		_tmp376_ = _tmp375_;
		if (_tmp376_) {
			gint state = 0;
			...
			_tmp377_ = ((ValaCCodeBaseModule*) self)->emit_context;
			_tmp378_ = _tmp377_->next_coroutine_state;
			_tmp377_->next_coroutine_state = _tmp378_ + 1;
			state = _tmp378_;
			_tmp379_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
			_tmp380_ = _tmp379_;
			_tmp381_ = vala_ccode_identifier_new ("_data_");
			_tmp382_ = _tmp381_;
			_tmp383_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp382_, "_state_");
			_tmp384_ = _tmp383_;
			_tmp385_ = state;
			_tmp386_ = g_strdup_printf ("%i", _tmp385_);
			_tmp387_ = _tmp386_;
			_tmp388_ = vala_ccode_constant_new (_tmp387_);
			_tmp389_ = _tmp388_;
			vala_ccode_function_add_assignment (_tmp380_, (ValaCCodeExpression*) _tmp384_, (ValaCCodeExpression*) _tmp389_);
			...
			_tmp394_ = _tmp393_;
			_tmp395_ = vala_ccode_constant_new ("FALSE");
			_tmp396_ = _tmp395_;
			vala_ccode_function_add_return (_tmp394_, (ValaCCodeExpression*) _tmp396_);
			_vala_ccode_node_unref0 (_tmp396_);
			_tmp397_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
			_tmp398_ = _tmp397_;
			_tmp399_ = state;
			_tmp400_ = g_strdup_printf ("_state_%d", _tmp399_);
			_tmp401_ = _tmp400_;
			vala_ccode_function_add_label (_tmp398_, _tmp401_);
			_g_free0 (_tmp401_);
			_tmp402_ = vala_ccode_identifier_new ("g_async_initable_new_finish");
			_tmp403_ = _tmp402_;
			...
			_tmp407_ = _tmp406_;
			_tmp408_ = vala_ccode_member_access_new_pointer ((ValaCCodeExpression*) _tmp407_, "_source_object_");
			_tmp409_ = _tmp408_;
			_tmp410_ = vala_ccode_cast_expression_new ((ValaCCodeExpression*) _tmp409_, "GAsyncInitable *");
			_tmp411_ = _tmp410_;
			...
			_tmp416_ = _tmp415_;
			vala_ccode_function_call_add_argument (_tmp412_, (ValaCCodeExpression*) _tmp416_);
			_vala_ccode_node_unref0 (_tmp416_);
			_vala_ccode_node_unref0 (_tmp414_);
			_tmp417_ = ccall;
			_tmp418_ = vala_ccode_base_module_get_variable_cexpression ((ValaCCodeBaseModule*) self, "_inner_error_");
			_tmp419_ = _tmp418_;
			_tmp420_ = vala_ccode_unary_expression_new (VALA_CCODE_UNARY_OPERATOR_ADDRESS_OF, _tmp419_);
			_tmp421_ = _tmp420_;
			vala_ccode_function_call_add_argument (_tmp417_, (ValaCCodeExpression*) _tmp421_);
			...
			_tmp423_ = _tmp422_;
			_tmp424_ = ccall;
			vala_ccode_function_add_expression (_tmp423_, (ValaCCodeExpression*) _tmp424_);
			_vala_ccode_node_unref0 (ccall);
	...
	_tmp425_ = vala_expression_get_value_type ((ValaExpression*) expr);
	_tmp426_ = _tmp425_;
	_tmp427_ = vala_expression_get_value_type ((ValaExpression*) expr);
	_tmp428_ = _tmp427_;
	_tmp429_ = vala_data_type_get_value_owned (_tmp428_);
	_tmp430_ = _tmp429_;
	_tmp431_ = vala_ccode_base_module_get_temp_variable ((ValaCCodeBaseModule*) self, _tmp426_, _tmp430_, NULL, FALSE);
	temp_var = _tmp431_;
	_tmp432_ = temp_var;
	...
	temp_ref = _tmp435_;
	_tmp436_ = temp_var;
	vala_ccode_base_module_emit_temp_var ((ValaCCodeBaseModule*) self, _tmp436_, FALSE);
	_tmp437_ = vala_ccode_base_module_get_ccode ((ValaCCodeBaseModule*) self);
	_tmp438_ = _tmp437_;
	_tmp439_ = temp_ref;
	_tmp440_ = ccall;
	_tmp441_ = vala_expression_get_value_type ((ValaExpression*) expr);
	_tmp442_ = _tmp441_;
	_tmp443_ = vala_get_ccode_name ((ValaCodeNode*) _tmp442_);
	_tmp444_ = _tmp443_;
	_tmp445_ = vala_ccode_cast_expression_new ((ValaCCodeExpression*) _tmp440_, _tmp444_);
	_tmp446_ = _tmp445_;
	vala_ccode_function_add_assignment (_tmp438_, _tmp439_, (ValaCCodeExpression*) _tmp446_);
	_vala_ccode_node_unref0 (_tmp446_);
	_g_free0 (_tmp444_);
	_tmp447_ = temp_ref;
	vala_ccode_base_module_set_cvalue ((ValaCCodeBaseModule*) self, (ValaExpression*) expr, _tmp447_);
	_vala_ccode_node_unref0 (temp_ref);
	_vala_code_node_unref0 (temp_var);
	_vala_ccode_node_unref0 (ccall);
	_vala_code_node_unref0 (cancellable);
