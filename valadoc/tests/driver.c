...
static gint ValadocDriversDriver_private_offset;
...
valadoc_drivers_driver_get_instance_private (ValadocDriversDriver* self)
{
	return G_STRUCT_MEMBER_P (self, ValadocDriversDriver_private_offset);
}
                                       ...
                                       ValadocErrorReporter* reporter)
{
	...
	_tmp8_ = valadoc_api_tree_get_context (_tmp7_);
	_tmp9_ = _tmp8_;
	...
	vala_gir_writer_write_file ((ValaGIRWriter*) _tmp6_, _tmp9_, _tmp10_, _tmp14_, _tmp15_, _tmp16_, _tmp17_, NULL);
	_g_free0 (_tmp14_);
	_g_free0 (gir_directory);
...
valadoc_drivers_driver_class_init (ValadocDriversDriverClass * klass)
{
	...
	g_type_class_adjust_private_offset (klass, &ValadocDriversDriver_private_offset);
...
{
	self->priv = valadoc_drivers_driver_get_instance_private (self);
}
...
valadoc_drivers_driver_get_type (void)
{
	...
	if (g_once_init_enter (&valadoc_drivers_driver_type_id__volatile)) {
		...
		ValadocDriversDriver_private_offset = g_type_add_instance_private (valadoc_drivers_driver_type_id, sizeof (ValadocDriversDriverPrivate));
